...
class ForexRatesDto(BaseModel):
    ...
    request_timestamp: Optional[datetime] = Field(default=None, alias="requestTimestamp")
    rates: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    __properties: ClassVar[List[str]] = ["success", "date", "base", "timestamp", "requestTimestamp", "rates"]
