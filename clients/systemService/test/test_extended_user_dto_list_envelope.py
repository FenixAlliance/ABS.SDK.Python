...
class TestExtendedUserDtoListEnvelope(unittest.TestCase):
    """ExtendedUserDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedUserDtoListEnvelope:
        """Test ExtendedUserDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedUserDtoListEnvelope`
        """
        model = ExtendedUserDtoListEnvelope()
        if include_optional:
            return ExtendedUserDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.extended_user_dto.ExtendedUserDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        full_name = '', 
                        qualified_name = '', 
    ...
    def testExtendedUserDtoListEnvelope(self):
        """Test ExtendedUserDtoListEnvelope"""
