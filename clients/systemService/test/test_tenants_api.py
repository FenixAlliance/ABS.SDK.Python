...
class TestTenantsApi(unittest.TestCase):
    ...
    def test_admin_preview_tenant_email(self) -> None:
        """Test case for admin_preview_tenant_email

        Preview the rendered email for a user.
        """
        pass

    def test_admin_send_tenant_email(self) -> None:
        """Test case for admin_send_tenant_email
