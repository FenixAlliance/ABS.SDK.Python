...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LicensingApi->get_license_assignments_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LicensingApi->get_license_attributes_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LicensingApi->get_license_by_id_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LicensingApi->get_license_features_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LicensingApi->get_license_records_quota_async: %s\n" % e)
```
...
# **get_licenses_async**
> SuiteLicenseDtoListEnvelope get_licenses_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a list of licenses
        api_response = api_instance.get_licenses_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
        print("The response of LicensingApi->get_licenses_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->get_licenses_async: %s\n" % e)
```
...
> BooleanEnvelope redeem_license_async(tenant_id, license_validation_request, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Redeem a license
        api_response = api_instance.redeem_license_async(tenant_id, license_validation_request, api_version=api_version, x_api_version=x_api_version)
        print("The response of LicensingApi->redeem_license_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->redeem_license_async: %s\n" % e)
```
...
> IValidationFailureListEnvelope validate_license_async(license_validation_request, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Validate a license
        api_response = api_instance.validate_license_async(license_validation_request, api_version=api_version, x_api_version=x_api_version)
        print("The response of LicensingApi->validate_license_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LicensingApi->validate_license_async: %s\n" % e)
```
