...
> EmptyEnvelope patch_account_holder_async(user_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Partially update a user
        api_response = api_instance.patch_account_holder_async(user_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of UsersApi->patch_account_holder_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->patch_account_holder_async: %s\n" % e)
```
