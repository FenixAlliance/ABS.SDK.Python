...
class Module(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enable", "active", "order", "id", "name", "fullName", "description", "type", "configuration", "author", "authorUrl", "license", "requireLicenseAcceptance", "repository", "path", "icon", "image", "nuSpecPath", "manifest", "documentation", "website", "logo", "swaggerSpec", "swaggerSpecs", "url", "assemblyPaths", "requiredPermissions", "markedForDeletion", "version"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Module', 'Integration', 'StudioModule', 'StudioIntegration']):
            raise ValueError("must be one of enum values ('Module', 'Integration', 'StudioModule', 'StudioIntegration')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if required_permissions (nullable) is None
        # and model_fields_set contains the field
        if self.required_permissions is None and "required_permissions" in self.model_fields_set:
            _dict['requiredPermissions'] = None
