...
class UserUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["qualifiedName", "birthday", "firstName", "lastName", "publicName", "idProvider", "gender", "email", "about", "status", "jobTitle", "timezoneId", "languageId", "currencyId", "countryId", "stateId", "cityId", "gitHubUrl", "websiteUrl", "twitterUrl", "facebookUrl", "youTubeUrl", "linkedInUrl", "instagramUrl", "webUrl", "availability"]
