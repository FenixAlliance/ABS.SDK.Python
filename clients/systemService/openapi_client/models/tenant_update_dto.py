...
class TenantUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "duns", "slogan", "legalName", "phone", "webUrl", "twitterUsername", "facebookUrl", "twitterUrl", "gitHubUrl", "linkedInUrl", "instagramUrl", "youTubeUrl", "whatsAppNumber", "supportPhoneNumber", "taxId", "about", "currencyId", "timezoneId", "languageId", "countryId", "stateId", "cityId", "email"]
