...
class ExtendedUserDto(BaseModel):
    ...
    site_theme: Optional[StrictStr] = Field(default=None, alias="siteTheme")
    ...
    def gender_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'Male', 'Female', 'PreferNotToSay']):
            raise ValueError("must be one of enum values ('Unknown', 'Male', 'Female', 'PreferNotToSay')")
        return value
    ...
    def availability_validate_enum(cls, value):
        ...
        if value not in set(['DND', 'Busy', 'Away', 'Offline', 'Available']):
            raise ValueError("must be one of enum values ('DND', 'Busy', 'Away', 'Offline', 'Available')")
        return value
    ...
    def site_theme_validate_enum(cls, value):
        ...
        if value not in set(['System', 'Light', 'Dark']):
            raise ValueError("must be one of enum values ('System', 'Light', 'Dark')")
        return value
