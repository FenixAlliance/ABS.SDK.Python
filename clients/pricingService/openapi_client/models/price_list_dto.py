...
class PriceListDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "startDate", "endDate", "description", "currencyId", "tenantId", "unitId", "unitGroupId", "partnerVisible", "unitOfMeasureDependant", "enrollmentId"]
