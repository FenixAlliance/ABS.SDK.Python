...
class PriceListDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "startDate", "endDate", "description", "context", "currencyId", "tenantId", "unitId", "unitGroupId", "partnerVisible", "unitOfMeasureDependant", "enrollmentId"]
