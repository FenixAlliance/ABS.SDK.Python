...
class DiscountUpdateDto(BaseModel):
    """
    DiscountUpdateDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "beginQuantity", "endQuantity", "percent", "value", "tenantId", "enrolmentId", "discountListId"]
