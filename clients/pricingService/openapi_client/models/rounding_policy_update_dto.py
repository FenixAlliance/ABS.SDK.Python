...
class RoundingPolicyUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId"]
