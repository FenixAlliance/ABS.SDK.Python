...
class RoundingPolicyDto(BaseModel):
    """
    RoundingPolicyDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId", "tenantId", "enrollmentId"]
