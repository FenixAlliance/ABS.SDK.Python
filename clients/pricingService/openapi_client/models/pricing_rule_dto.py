...
class PricingRuleDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId"]
