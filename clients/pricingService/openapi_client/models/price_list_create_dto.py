...
class PriceListCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "context", "startDate", "endDate", "currencyId", "unitId", "unitGroupId", "partnerVisible", "unitOfMeasureDependant"]

    @field_validator('name')
    def name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[a-zA-Z0-9\s]*$", value):
            raise ValueError(r"must validate the regular expression /^[a-zA-Z0-9\s]*$/")
        return value
    ...
    def context_validate_enum(cls, value):
        ...
        if value not in set(['Sales', 'Purchase', 'Cost']):
            raise ValueError("must be one of enum values ('Sales', 'Purchase', 'Cost')")
        return value
