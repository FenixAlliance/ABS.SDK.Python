...
> EmptyEnvelope patch_rounding_policy_async(tenant_id, rounding_policy_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patches a rounding policy
        api_response = api_instance.patch_rounding_policy_async(tenant_id, rounding_policy_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of RoundingPoliciesApi->patch_rounding_policy_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoundingPoliciesApi->patch_rounding_policy_async: %s\n" % e)
```
