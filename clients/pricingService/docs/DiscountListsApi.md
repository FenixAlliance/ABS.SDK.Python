...
# **patch_discount_list**
> EmptyEnvelope patch_discount_list(tenant_id, discount_list_id, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patches a discount list
        api_response = api_instance.patch_discount_list(tenant_id, discount_list_id, operation=operation)
        print("The response of DiscountListsApi->patch_discount_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountListsApi->patch_discount_list: %s\n" % e)
```
...
> EmptyEnvelope patch_discount_list_entry(tenant_id, discount_list_id, discount_list_entry_id, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patches a discount list entry
        api_response = api_instance.patch_discount_list_entry(tenant_id, discount_list_id, discount_list_entry_id, operation=operation)
        print("The response of DiscountListsApi->patch_discount_list_entry:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscountListsApi->patch_discount_list_entry: %s\n" % e)
```
