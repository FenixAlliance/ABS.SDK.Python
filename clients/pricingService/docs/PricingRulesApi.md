...
> PricingRuleDtoEnvelope get_pricing_rule_by_id(tenant_id, pricing_rule_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get pricing rule by ID
        api_response = api_instance.get_pricing_rule_by_id(tenant_id, pricing_rule_id, api_version=api_version, x_api_version=x_api_version)
...
> Int32Envelope get_pricing_rules_count_async(tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Counts pricing rules
        api_response = api_instance.get_pricing_rules_count_async(tenant_id, api_version=api_version, x_api_version=x_api_version)
        print("The response of PricingRulesApi->get_pricing_rules_count_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PricingRulesApi->get_pricing_rules_count_async: %s\n" % e)
```
...
# **patch_pricing_rule**
> patch_pricing_rule(tenant_id, pricing_rule_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a pricing rule
        api_instance.patch_pricing_rule(tenant_id, pricing_rule_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
    except Exception as e:
        print("Exception when calling PricingRulesApi->patch_pricing_rule: %s\n" % e)
```
