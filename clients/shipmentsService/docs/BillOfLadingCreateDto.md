...
json = "{}"
# create an instance of BillOfLadingCreateDto from a JSON string
bill_of_lading_create_dto_instance = BillOfLadingCreateDto.from_json(json)
# print the JSON string representation of the object
print(BillOfLadingCreateDto.to_json())

# convert the object into a dict
bill_of_lading_create_dto_dict = bill_of_lading_create_dto_instance.to_dict()
# create an instance of BillOfLadingCreateDto from a dict
bill_of_lading_create_dto_from_dict = BillOfLadingCreateDto.from_dict(bill_of_lading_create_dto_dict)
```
