...
class ShipmentDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "trackingCode", "isInternational", "shipped", "delivered", "shipmentTimestamp", "deliveryTimestamp", "expectedShippingDate", "expectedDeliveryDate", "shippingTerms", "orderId", "tenantId"]
