...
class ShippingLabelDto(BaseModel):
    """
    ShippingLabelDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "trackingCode", "expectedDelivery", "locationID", "businessID", "shipmentID", "shippingCourierID"]
