...
class ShipmentUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trackingCode", "isInternational", "shipped", "delivered", "shipmentTimestamp", "deliveryTimestamp", "expectedShippingDate", "expectedDeliveryDate", "shippingTerms", "orderID"]
