...
class BillOfLadingLineUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "quantity", "packageType", "grossWeightKg", "volumeM3", "marksAndNumbers", "hsCode", "itemId"]
