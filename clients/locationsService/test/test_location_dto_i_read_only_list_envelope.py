...
class TestLocationDtoIReadOnlyListEnvelope(unittest.TestCase):
    """LocationDtoIReadOnlyListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationDtoIReadOnlyListEnvelope:
        """Test LocationDtoIReadOnlyListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationDtoIReadOnlyListEnvelope`
        """
        model = LocationDtoIReadOnlyListEnvelope()
        if include_optional:
    ...
    def testLocationDtoIReadOnlyListEnvelope(self):
        """Test LocationDtoIReadOnlyListEnvelope"""
