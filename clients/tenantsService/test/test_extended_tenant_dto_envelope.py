...
class TestExtendedTenantDtoEnvelope(unittest.TestCase):
    """ExtendedTenantDtoEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedTenantDtoEnvelope:
        """Test ExtendedTenantDtoEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedTenantDtoEnvelope`
        """
        model = ExtendedTenantDtoEnvelope()
        if include_optional:
            return ExtendedTenantDtoEnvelope(
                ...
                activity_id = '',
                result = openapi_client.models.extended_tenant_dto.ExtendedTenantDto(
                    id = '', 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    qualified_name = '', 
                    tax_id = '', 
    ...
    def testExtendedTenantDtoEnvelope(self):
        """Test ExtendedTenantDtoEnvelope"""
