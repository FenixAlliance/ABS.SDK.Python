...
class TestExtendedTenantEnrollmentDto(unittest.TestCase):
    """ExtendedTenantEnrollmentDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedTenantEnrollmentDto:
        """Test ExtendedTenantEnrollmentDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedTenantEnrollmentDto`
        """
        model = ExtendedTenantEnrollmentDto()
        if include_optional:
            return ExtendedTenantEnrollmentDto(
                id = '',
    ...
    def testExtendedTenantEnrollmentDto(self):
        """Test ExtendedTenantEnrollmentDto"""
