...
> EmptyEnvelope patch_tenant_employee_enrollment_async(tenant_id, tenant_employee_enrollment_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant employee enrollment
        api_response = api_instance.patch_tenant_employee_enrollment_async(tenant_id, tenant_employee_enrollment_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of EmployeeEnrollmentsApi->patch_tenant_employee_enrollment_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmployeeEnrollmentsApi->patch_tenant_employee_enrollment_async: %s\n" % e)
```
