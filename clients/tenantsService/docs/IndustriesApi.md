...
> EmptyEnvelope patch_tenant_industry_async(tenant_id, tenant_industry_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant industry
        api_response = api_instance.patch_tenant_industry_async(tenant_id, tenant_industry_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of IndustriesApi->patch_tenant_industry_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IndustriesApi->patch_tenant_industry_async: %s\n" % e)
```
