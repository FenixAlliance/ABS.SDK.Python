...
> EmptyEnvelope patch_tenant_territory(tenant_id, tenant_territory_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant territory
        api_response = api_instance.patch_tenant_territory(tenant_id, tenant_territory_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TerritoriesApi->patch_tenant_territory:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TerritoriesApi->patch_tenant_territory: %s\n" % e)
```
