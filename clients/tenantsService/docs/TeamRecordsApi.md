...
> EmptyEnvelope patch_tenant_team_record(tenant_id, tenant_team_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant team record
        api_response = api_instance.patch_tenant_team_record(tenant_id, tenant_team_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TeamRecordsApi->patch_tenant_team_record:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TeamRecordsApi->patch_tenant_team_record: %s\n" % e)
```
