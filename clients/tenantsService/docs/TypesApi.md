...
# **patch_tenant_type**
> EmptyEnvelope patch_tenant_type(tenant_id, tenant_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant type
        api_response = api_instance.patch_tenant_type(tenant_id, tenant_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TypesApi->patch_tenant_type:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TypesApi->patch_tenant_type: %s\n" % e)
```
