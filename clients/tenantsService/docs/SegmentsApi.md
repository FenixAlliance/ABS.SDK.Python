...
> EmptyEnvelope patch_tenant_segment(tenant_id, tenant_segment_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tenant segment
        api_response = api_instance.patch_tenant_segment(tenant_id, tenant_segment_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of SegmentsApi->patch_tenant_segment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SegmentsApi->patch_tenant_segment: %s\n" % e)
```
