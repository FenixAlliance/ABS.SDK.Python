...
class TenantIndustryDto(BaseModel):
    """
    TenantIndustryDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "name", "parentBusinessIndustryId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_business_industry_id (nullable) is None
        # and model_fields_set contains the field
