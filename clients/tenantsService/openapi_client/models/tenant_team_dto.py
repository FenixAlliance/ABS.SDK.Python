...
class TenantTeamDto(BaseModel):
    ...
    business_unit_id: Optional[StrictStr] = Field(default=None, alias="businessUnitId")
    organization_profile_id: Optional[StrictStr] = Field(default=None, alias="organizationProfileId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "name", "description", "avatarUrl", "isPublic", "businessUnitId", "organizationProfileId"]
