...
class NotificationDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "read", "icon", "message", "imageUrl", "redirectUrl", "type", "socialProfileId", "readTimestamp", "issuedTimestamp"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Event', 'Alert', 'Log']):
            raise ValueError("must be one of enum values ('Event', 'Alert', 'Log')")
        return value
