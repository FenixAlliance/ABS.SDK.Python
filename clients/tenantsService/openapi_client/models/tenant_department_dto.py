...
class TenantDepartmentDto(BaseModel):
    """
    TenantDepartmentDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "businessID", "businessProfileRecordID", "name", "description", "disabled", "organizationProfileID", "parentDepartmentID"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_department_id (nullable) is None
        # and model_fields_set contains the field
        if self.parent_department_id is None and "parent_department_id" in self.model_fields_set:
            _dict['parentDepartmentID'] = None
