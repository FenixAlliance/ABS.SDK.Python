...
class TenantDepartmentCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "disabled", "organizationProfileID", "parentDepartmentID"]
