...
> EmptyEnvelope patch_subscription_async(tenant_id, subscription_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a subscription
        api_response = api_instance.patch_subscription_async(tenant_id, subscription_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of SubscriptionsApi->patch_subscription_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubscriptionsApi->patch_subscription_async: %s\n" % e)
```
