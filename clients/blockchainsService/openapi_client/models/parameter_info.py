...
class ParameterInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributes", "member", "name", "parameterType", "position", "isIn", "isLcid", "isOptional", "isOut", "isRetval", "defaultValue", "rawDefaultValue", "hasDefaultValue", "customAttributes", "metadataToken"]
    ...
    def attributes_validate_enum(cls, value):
        ...
        if value not in set(['None', 'In', 'Out', 'Lcid', 'Retval', 'Optional', 'HasDefault', 'HasFieldMarshal', 'Reserved3', 'Reserved4', 'ReservedMask']):
            raise ValueError("must be one of enum values ('None', 'In', 'Out', 'Lcid', 'Retval', 'Optional', 'HasDefault', 'HasFieldMarshal', 'Reserved3', 'Reserved4', 'ReservedMask')")
        return value
