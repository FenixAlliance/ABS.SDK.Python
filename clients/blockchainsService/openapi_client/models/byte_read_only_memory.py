...
class ByteReadOnlyMemory(BaseModel):
    """
    ByteReadOnlyMemory
    """ # noqa: E501
    length: Optional[StrictInt] = None
    is_empty: Optional[StrictBool] = Field(default=None, alias="isEmpty")
    span: Optional[ByteReadOnlySpan] = None
    __properties: ClassVar[List[str]] = ["length", "isEmpty", "span"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "span": ByteReadOnlySpan.from_dict(obj["span"]) if obj.get("span") is not None else None
        })
        return _obj
