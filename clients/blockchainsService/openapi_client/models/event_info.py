...
class EventInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "declaringType", "reflectedType", "module", "customAttributes", "isCollectible", "metadataToken", "memberType", "attributes", "isSpecialName", "addMethod", "removeMethod", "raiseMethod", "isMulticast", "eventHandlerType"]
    ...
    def attributes_validate_enum(cls, value):
        ...
        if value not in set(['None', 'SpecialName', 'RTSpecialName']):
            raise ValueError("must be one of enum values ('None', 'SpecialName', 'RTSpecialName')")
        return value
