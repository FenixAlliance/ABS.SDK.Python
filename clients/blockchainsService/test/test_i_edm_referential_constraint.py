...
class TestIEdmReferentialConstraint(unittest.TestCase):
    """IEdmReferentialConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IEdmReferentialConstraint:
        ...
        """
        model = IEdmReferentialConstraint()
        if include_optional:
            return IEdmReferentialConstraint(
                property_pairs = [
    ...
    def testIEdmReferentialConstraint(self):
        """Test IEdmReferentialConstraint"""
