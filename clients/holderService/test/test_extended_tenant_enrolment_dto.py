...
class TestExtendedTenantEnrolmentDto(unittest.TestCase):
    """ExtendedTenantEnrolmentDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedTenantEnrolmentDto:
        """Test ExtendedTenantEnrolmentDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedTenantEnrolmentDto`
        """
        model = ExtendedTenantEnrolmentDto()
        if include_optional:
            return ExtendedTenantEnrolmentDto(
                id = '',
    ...
    def testExtendedTenantEnrolmentDto(self):
        """Test ExtendedTenantEnrolmentDto"""
