...
> EmptyEnvelope patch_payment_mode_async(tenant_id, payment_mode_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a payment mode
        api_response = api_instance.patch_payment_mode_async(tenant_id, payment_mode_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of PaymentModesApi->patch_payment_mode_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentModesApi->patch_payment_mode_async: %s\n" % e)
```
