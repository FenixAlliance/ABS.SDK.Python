...
class PaymentCreateDto(BaseModel):
    ...
    def on_behalf_of_validate_enum(cls, value):
        ...
        if value not in set(['Self', 'Tenant', 'Individual', 'Organization']):
            raise ValueError("must be one of enum values ('Self', 'Tenant', 'Individual', 'Organization')")
        return value
    ...
    def payment_type_validate_enum(cls, value):
        ...
        if value not in set(['Paid', 'Received', 'Internal']):
            raise ValueError("must be one of enum values ('Paid', 'Received', 'Internal')")
        return value
    ...
    def payment_status_validate_enum(cls, value):
        ...
        if value not in set(['Unset', 'Accepted', 'Rejected', 'OnHold', 'Failed', 'Reversed', 'Retained', 'Initialized', 'Expired', 'Abandoned', 'Cancelled', 'AcceptedRetained']):
            raise ValueError("must be one of enum values ('Unset', 'Accepted', 'Rejected', 'OnHold', 'Failed', 'Reversed', 'Retained', 'Initialized', 'Expired', 'Abandoned', 'Cancelled', 'AcceptedRetained')")
        return value
