...
class TestItemCartRecordDto(unittest.TestCase):
    """ItemCartRecordDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemCartRecordDto:
        """Test ItemCartRecordDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemCartRecordDto`
        """
        model = ItemCartRecordDto()
        if include_optional:
    ...
    def testItemCartRecordDto(self):
        """Test ItemCartRecordDto"""
