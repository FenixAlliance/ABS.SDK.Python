...
class TestItemCartRecordDtoEnvelope(unittest.TestCase):
    """ItemCartRecordDtoEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemCartRecordDtoEnvelope:
        """Test ItemCartRecordDtoEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemCartRecordDtoEnvelope`
        """
        model = ItemCartRecordDtoEnvelope()
        if include_optional:
            return ItemCartRecordDtoEnvelope(
                is_success = True,
                error_message = '',
                correlation_id = '',
                timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                activity_id = '',
                result = openapi_client.models.item_cart_record_dto.ItemCartRecordDto(
                    id = '', 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed = True, 
                    item_id = '', 
    ...
    def testItemCartRecordDtoEnvelope(self):
        """Test ItemCartRecordDtoEnvelope"""
