...
class TestItemCartRecordDtoListEnvelope(unittest.TestCase):
    """ItemCartRecordDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemCartRecordDtoListEnvelope:
        """Test ItemCartRecordDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemCartRecordDtoListEnvelope`
        """
        model = ItemCartRecordDtoListEnvelope()
        if include_optional:
            return ItemCartRecordDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.item_cart_record_dto.ItemCartRecordDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        closed = True, 
                        item_id = '', 
    ...
    def testItemCartRecordDtoListEnvelope(self):
        """Test ItemCartRecordDtoListEnvelope"""
