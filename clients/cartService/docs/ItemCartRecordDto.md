...
item_cart_record_dto_instance = ItemCartRecordDto.from_json(json)
# print the JSON string representation of the object
print(ItemCartRecordDto.to_json())

# convert the object into a dict
item_cart_record_dto_dict = item_cart_record_dto_instance.to_dict()
# create an instance of ItemCartRecordDto from a dict
item_cart_record_dto_from_dict = ItemCartRecordDto.from_dict(item_cart_record_dto_dict)
```
