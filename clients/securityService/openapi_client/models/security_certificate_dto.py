...
class SecurityCertificateDto(BaseModel):
    """
    ...
    expire_period: Optional[StrictStr] = Field(default=None, alias="expirePeriod")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "type", "expirePeriod", "expired", "disabled", "businessID", "csr"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if expire_period (nullable) is None
        # and model_fields_set contains the field
        if self.expire_period is None and "expire_period" in self.model_fields_set:
