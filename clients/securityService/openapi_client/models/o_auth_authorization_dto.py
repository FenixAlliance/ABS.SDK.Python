...
class OAuthAuthorizationDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "concurrencyToken", "creationDate", "properties", "scopes", "status", "subject", "type", "applicationId", "tokensCount"]
