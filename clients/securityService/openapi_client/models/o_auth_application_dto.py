...
class OAuthApplicationDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "applicationType", "clientId", "concurrencyToken", "consentType", "displayName", "displayNames", "permissions", "postLogoutRedirectUris", "properties", "redirectUris", "requirements", "settings", "type", "logo", "businessID", "businessProfileRecordID", "businessApplicationID", "authorizationsCount", "tokensCount"]
