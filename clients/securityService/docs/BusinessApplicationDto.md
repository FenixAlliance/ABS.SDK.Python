...
business_application_dto_instance = BusinessApplicationDto.from_json(json)
# print the JSON string representation of the object
print(BusinessApplicationDto.to_json())

# convert the object into a dict
business_application_dto_dict = business_application_dto_instance.to_dict()
# create an instance of BusinessApplicationDto from a dict
business_application_dto_from_dict = BusinessApplicationDto.from_dict(business_application_dto_dict)
```
