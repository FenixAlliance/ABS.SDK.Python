...
class SupportTicketConversationCreateDto(BaseModel):
    """
    ...
    social_profile_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="socialProfileID")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "topic", "closed", "closedTimestamp", "socialProfileID"]
