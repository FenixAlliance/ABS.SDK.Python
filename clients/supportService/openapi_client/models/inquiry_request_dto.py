...
class InquiryRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "type", "name", "lastName", "email", "organizationName", "jobRole", "organizationDomain", "countryId", "phone", "message", "tenantId", "enrollmentId", "userId", "socialProfileId"]
