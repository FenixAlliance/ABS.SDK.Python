...
class InquiryRequestDto(BaseModel):
    """
    InquiryRequestDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "type", "name", "lastName", "email", "organizationName", "jobRole", "organizationDomain", "countryId", "phone", "message", "tenantId", "businessProfileRecordId", "accountHolderId", "socialProfileId"]
