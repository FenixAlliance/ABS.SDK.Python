...
class RefundRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "businessProfileRecordId", "supportEntitlementId", "contactId", "accountHolderId", "refundPolicyId", "paymentId"]
