...
class ItemWarrantyPolicyDto(BaseModel):
    """
    ...
    currency_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, alias="currencyID")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "isExtendedWarranty", "code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyID", "countryID", "countryStateID", "customState", "customCity", "cityID", "businessID", "businessProfileRecordID"]
