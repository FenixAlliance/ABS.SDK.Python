...
class WarrantyRequestCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "contactId", "warrantyPolicyId"]
