...
class ItemRefundPolicyUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyID", "countryID", "countryStateID", "customState", "customCity", "cityID"]
