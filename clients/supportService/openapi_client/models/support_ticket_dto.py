...
class SupportTicketDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "supportTicketStatus", "userId", "contactId", "tenantId", "enrollmentId", "supportTicketTypeId", "supportEntitlementId", "supportPriorityId"]
