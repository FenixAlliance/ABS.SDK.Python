...
class SupportTicketCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "supportTicketStatus", "contactId", "supportTicketTypeId", "supportEntitlementId", "supportPriorityId"]
