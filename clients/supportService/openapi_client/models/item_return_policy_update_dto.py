...
class ItemReturnPolicyUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "shippingCourierId", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyId", "countryId", "countryStateId", "customState", "customCity", "cityId"]
