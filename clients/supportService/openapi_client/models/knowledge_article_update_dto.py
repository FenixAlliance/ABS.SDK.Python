...
class KnowledgeArticleUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "slug", "excerpt", "description", "content", "highlightImage", "seoTitle", "seoKeyWords", "metaDescription", "published", "enable"]
