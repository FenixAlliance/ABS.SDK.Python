...
class RefundRequestUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "refundPolicyId", "paymentId"]
