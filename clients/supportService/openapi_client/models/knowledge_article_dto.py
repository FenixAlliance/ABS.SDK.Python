...
class KnowledgeArticleDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "slug", "excerpt", "description", "content", "highlightImage", "seoTitle", "seoKeyWords", "metaDescription", "published", "enable", "releaseDateTime", "lastModification", "tenantId", "businessProfileRecordId"]
