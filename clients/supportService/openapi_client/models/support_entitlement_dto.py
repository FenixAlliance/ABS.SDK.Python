...
class SupportEntitlementDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "status", "startDateTime", "endDateTime", "nextInvoiceDateTime", "code", "signature", "quantity", "repetitions", "chargeAttempts", "freeTrialInDays", "gracePeriodInDays", "customRenewalPeriod", "enableAutomaticRenew", "enableProRateBilling", "enableUsageThreshold", "enableAutomaticDisable", "enableAutomaticPayments", "usageThreshold", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "userId", "individualId", "organizationId", "receiverTenantId", "tenantId", "enrollmentId", "paymentTokenId", "walletAccountId", "securityCertificateId"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Active', 'GracePeriod', 'Disabled', 'Deleted']):
            raise ValueError("must be one of enum values ('Active', 'GracePeriod', 'Disabled', 'Deleted')")
        return value
