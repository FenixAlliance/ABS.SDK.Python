...
class RefundRequestCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "contactId", "refundPolicyId", "paymentId"]
