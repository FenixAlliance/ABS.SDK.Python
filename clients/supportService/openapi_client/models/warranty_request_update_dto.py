...
class WarrantyRequestUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "approved", "approvedTimestamp", "supportEntitlementId", "warrantyPolicyId"]
