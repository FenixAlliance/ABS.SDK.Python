...
class WarrantyRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "enrollmentId", "supportEntitlementId", "contactId", "userId", "warrantyPolicyId"]
