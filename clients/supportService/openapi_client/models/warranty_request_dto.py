...
class WarrantyRequestDto(BaseModel):
    """
    WarrantyRequestDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "approved", "approvedTimestamp", "tenantId", "businessProfileRecordId", "supportEntitlementId", "contactId", "accountHolderId", "warrantyPolicyId"]
