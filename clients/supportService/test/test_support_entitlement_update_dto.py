...
class TestSupportEntitlementUpdateDto(unittest.TestCase):
    """SupportEntitlementUpdateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportEntitlementUpdateDto:
        """Test SupportEntitlementUpdateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportEntitlementUpdateDto`
        """
        model = SupportEntitlementUpdateDto()
        if include_optional:
            return SupportEntitlementUpdateDto(
                title = '',
                description = '',
    ...
    def testSupportEntitlementUpdateDto(self):
        """Test SupportEntitlementUpdateDto"""
