...
class TestSupportEntitlementCreateDto(unittest.TestCase):
    """SupportEntitlementCreateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportEntitlementCreateDto:
        """Test SupportEntitlementCreateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportEntitlementCreateDto`
        """
        model = SupportEntitlementCreateDto()
        if include_optional:
            return SupportEntitlementCreateDto(
                id = '',
    ...
    def testSupportEntitlementCreateDto(self):
        """Test SupportEntitlementCreateDto"""
