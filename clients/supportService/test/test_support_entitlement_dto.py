...
class TestSupportEntitlementDto(unittest.TestCase):
    """SupportEntitlementDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportEntitlementDto:
        """Test SupportEntitlementDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportEntitlementDto`
        """
        model = SupportEntitlementDto()
        if include_optional:
            return SupportEntitlementDto(
                id = '',
    ...
    def testSupportEntitlementDto(self):
        """Test SupportEntitlementDto"""
