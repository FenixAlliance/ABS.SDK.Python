...
> EmptyEnvelope patch_warranty_request_async(tenant_id, warranty_request_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a warranty request
        api_response = api_instance.patch_warranty_request_async(tenant_id, warranty_request_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of WarrantyRequestsApi->patch_warranty_request_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WarrantyRequestsApi->patch_warranty_request_async: %s\n" % e)
```
