...
> EmptyEnvelope patch_support_ticket_priority_async(tenant_id, support_ticket_priority_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a support ticket priority
        api_response = api_instance.patch_support_ticket_priority_async(tenant_id, support_ticket_priority_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of SupportTicketPrioritiesApi->patch_support_ticket_priority_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SupportTicketPrioritiesApi->patch_support_ticket_priority_async: %s\n" % e)
```
