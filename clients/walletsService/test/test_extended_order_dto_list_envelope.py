...
class TestExtendedOrderDtoListEnvelope(unittest.TestCase):
    """ExtendedOrderDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedOrderDtoListEnvelope:
        """Test ExtendedOrderDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedOrderDtoListEnvelope`
        """
        model = ExtendedOrderDtoListEnvelope()
        if include_optional:
            return ExtendedOrderDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.extended_order_dto.ExtendedOrderDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        closed = True, 
                        type = '', 
    ...
    def testExtendedOrderDtoListEnvelope(self):
        """Test ExtendedOrderDtoListEnvelope"""
