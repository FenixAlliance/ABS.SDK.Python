...
class PaymentChargebackDtoListEnvelope(BaseModel):
    """
    ...
    result: Optional[List[PaymentChargebackDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [PaymentChargebackDto.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
