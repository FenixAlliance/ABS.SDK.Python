...
class PaymentTokenCreateDto(BaseModel):
    """
    PaymentTokenCreateDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    mask: Annotated[str, Field(min_length=1, strict=True)]
    ...
    card_expiration_month: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="cardExpirationMonth")
    card_expiration_year: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="cardExpirationYear")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "mask", "tokenType", "cardFranchise", "cardExpirationMonth", "cardExpirationYear", "validUntil", "paymentGatewayId"]
