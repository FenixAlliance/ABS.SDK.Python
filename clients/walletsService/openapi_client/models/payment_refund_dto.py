...
class PaymentRefundDto(BaseModel):
    ...
    refund_request_id: Optional[StrictStr] = Field(default=None, alias="refundRequestId")
    total_fees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalFees")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "paymentId", "walletAccountId", "refundRequestId", "totalFees"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if refund_request_id (nullable) is None
        # and model_fields_set contains the field
        if self.refund_request_id is None and "refund_request_id" in self.model_fields_set:
            _dict['refundRequestId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refundRequestId": obj.get("refundRequestId"),
