...
class PaymentChargebackDto(BaseModel):
    """
    ...
    bank_profile_name: Optional[StrictStr] = Field(default=None, alias="bankProfileName")
    total_fees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalFees")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "requestDate", "paymentId", "bankProfileId", "bankProfileName", "totalFees"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bank_profile_name (nullable) is None
        # and model_fields_set contains the field
        if self.bank_profile_name is None and "bank_profile_name" in self.model_fields_set:
            _dict['bankProfileName'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankProfileName": obj.get("bankProfileName"),
