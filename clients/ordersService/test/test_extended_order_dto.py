...
class TestExtendedOrderDto(unittest.TestCase):
    """ExtendedOrderDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedOrderDto:
        """Test ExtendedOrderDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedOrderDto`
        """
        model = ExtendedOrderDto()
        if include_optional:
            return ExtendedOrderDto(
                id = '',
