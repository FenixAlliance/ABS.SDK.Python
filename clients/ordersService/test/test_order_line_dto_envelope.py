...
class TestOrderLineDtoEnvelope(unittest.TestCase):
    """OrderLineDtoEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderLineDtoEnvelope:
        """Test OrderLineDtoEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderLineDtoEnvelope`
        """
        model = OrderLineDtoEnvelope()
        if include_optional:
            return OrderLineDtoEnvelope(
                ...
                activity_id = '',
                result = openapi_client.models.order_line_dto.OrderLineDto(
                    id = '', 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed = True, 
                    item_id = '', 
    ...
    def testOrderLineDtoEnvelope(self):
        """Test OrderLineDtoEnvelope"""
