...
class TestOrderLineDtoListEnvelope(unittest.TestCase):
    """OrderLineDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderLineDtoListEnvelope:
        """Test OrderLineDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderLineDtoListEnvelope`
        """
        model = OrderLineDtoListEnvelope()
        if include_optional:
            return OrderLineDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.order_line_dto.OrderLineDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        closed = True, 
                        item_id = '', 
    ...
    def testOrderLineDtoListEnvelope(self):
        """Test OrderLineDtoListEnvelope"""
