...
class TestOrderLineUpdateDto(unittest.TestCase):
    """OrderLineUpdateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderLineUpdateDto:
        """Test OrderLineUpdateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderLineUpdateDto`
        """
        model = OrderLineUpdateDto()
        if include_optional:
            return OrderLineUpdateDto(
                closed = True,
                item_id = '',
                item_title = '',
    ...
    def testOrderLineUpdateDto(self):
        """Test OrderLineUpdateDto"""
