...
order_line_dto_instance = OrderLineDto.from_json(json)
# print the JSON string representation of the object
print(OrderLineDto.to_json())

# convert the object into a dict
order_line_dto_dict = order_line_dto_instance.to_dict()
# create an instance of OrderLineDto from a dict
order_line_dto_from_dict = OrderLineDto.from_dict(order_line_dto_dict)
```
