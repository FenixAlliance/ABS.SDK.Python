...
json = "{}"
# create an instance of OrderLineCreateDto from a JSON string
order_line_create_dto_instance = OrderLineCreateDto.from_json(json)
# print the JSON string representation of the object
print(OrderLineCreateDto.to_json())

# convert the object into a dict
order_line_create_dto_dict = order_line_create_dto_instance.to_dict()
# create an instance of OrderLineCreateDto from a dict
order_line_create_dto_from_dict = OrderLineCreateDto.from_dict(order_line_create_dto_dict)
```
