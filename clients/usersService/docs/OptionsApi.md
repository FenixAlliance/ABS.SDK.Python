...
# **patch_user_option**
> EmptyEnvelope patch_user_option(option_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a user option
        api_response = api_instance.patch_user_option(option_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of OptionsApi->patch_user_option:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OptionsApi->patch_user_option: %s\n" % e)
```
