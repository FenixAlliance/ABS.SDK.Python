...
class SocialPostAttachmentDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "notes", "title", "author", "isFolder", "hash", "fileUrl", "filePath", "fileName", "abstract", "keyWords", "metadata", "fileLength", "contentType", "parentFileId", "validResponse", "userId", "tenantId", "enrollmentId", "socialProfileId", "folderPath", "socialPostId"]
