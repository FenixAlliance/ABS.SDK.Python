...
class SocialPostAttachmentUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["notes", "metadata", "title", "author", "isFolder", "fileName", "abstract", "keyWords", "validResponse", "parentFileUploadID", "filePath"]
