...
class SocialFeedDto(BaseModel):
    """
    SocialFeedDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    social_posts_count: Optional[StrictInt] = Field(default=None, alias="socialPostsCount")
    social_profile_id: Optional[StrictStr] = Field(default=None, alias="socialProfileId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "socialPostsCount", "socialProfileId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "socialPostsCount": obj.get("socialPostsCount"),
