...
> EmptyEnvelope patch_social_group_async(tenant_id, social_profile_id, social_group_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a social group
        api_response = api_instance.patch_social_group_async(tenant_id, social_profile_id, social_group_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of SocialGroupsApi->patch_social_group_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SocialGroupsApi->patch_social_group_async: %s\n" % e)
```
