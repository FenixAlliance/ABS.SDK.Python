...
class TestInvoiceLineDto(unittest.TestCase):
    """InvoiceLineDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceLineDto:
        """Test InvoiceLineDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceLineDto`
        """
        model = InvoiceLineDto()
        if include_optional:
