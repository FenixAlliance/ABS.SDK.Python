...
class TestInvoiceLineDtoListEnvelope(unittest.TestCase):
    """InvoiceLineDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceLineDtoListEnvelope:
        """Test InvoiceLineDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceLineDtoListEnvelope`
        """
        model = InvoiceLineDtoListEnvelope()
        if include_optional:
    ...
    def testInvoiceLineDtoListEnvelope(self):
        """Test InvoiceLineDtoListEnvelope"""
