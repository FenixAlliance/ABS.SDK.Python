...
class InvoiceAdjustmentDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "invoiceId", "currencyId", "enrollmentId", "priority", "code", "description", "surchargePercent", "surchargeAmount", "discountPercent", "discountAmount", "totalSurcharge", "totalDiscount", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Discount', 'Surcharge']):
            raise ValueError("must be one of enum values ('Discount', 'Surcharge')")
        return value
