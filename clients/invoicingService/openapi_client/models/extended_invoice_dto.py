...
class ExtendedInvoiceDto(BaseModel):
    ...
    enrollment: Optional[SimpleTenantEnrollmentDto] = None
    invoice_lines: Optional[List[InvoiceLineDto]] = Field(default=None, alias="invoiceLines")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enrollment": SimpleTenantEnrollmentDto.from_dict(obj["enrollment"]) if obj.get("enrollment") is not None else None,
            "invoiceLines": [InvoiceLineDto.from_dict(_item) for _item in obj["invoiceLines"]] if obj.get("invoiceLines") is not None else None
        })
        return _obj
