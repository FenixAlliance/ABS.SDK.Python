...
class InvoiceReferenceDto(BaseModel):
    """
    InvoiceReferenceDto
    """ # noqa: E501
    ...
    referral_invoice_id: Optional[StrictStr] = Field(default=None, alias="referralInvoiceId")
    referenced_invoice_id: Optional[StrictStr] = Field(default=None, alias="referencedInvoiceId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "referralInvoiceId", "referencedInvoiceId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if referral_invoice_id (nullable) is None
        # and model_fields_set contains the field
        if self.referral_invoice_id is None and "referral_invoice_id" in self.model_fields_set:
            _dict['referralInvoiceId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "referralInvoiceId": obj.get("referralInvoiceId"),
