...
class SimpleUserDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "fullName", "qualifiedName", "publicName", "handler", "lastName", "firstName", "coverUrl", "avatarUrl", "gitHubUrl", "countryId", "timezoneId", "websiteUrl", "twitterUrl", "youTubeUrl", "linkedInUrl", "facebookUrl", "instagramUrl", "socialProfileId"]
