...
class TestInstructorProfileDto(unittest.TestCase):
    """InstructorProfileDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstructorProfileDto:
        """Test InstructorProfileDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstructorProfileDto`
        """
    ...
    def testInstructorProfileDto(self):
        """Test InstructorProfileDto"""
