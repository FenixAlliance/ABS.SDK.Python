...
> EmptyEnvelope patch_course_content_group_async(tenant_id, group_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a course content group
        api_response = api_instance.patch_course_content_group_async(tenant_id, group_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CourseContentGroupsApi->patch_course_content_group_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CourseContentGroupsApi->patch_course_content_group_async: %s\n" % e)
```
