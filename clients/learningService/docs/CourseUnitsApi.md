...
> EmptyEnvelope patch_course_unit_async(tenant_id, unit_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a course unit
        api_response = api_instance.patch_course_unit_async(tenant_id, unit_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CourseUnitsApi->patch_course_unit_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CourseUnitsApi->patch_course_unit_async: %s\n" % e)
```
