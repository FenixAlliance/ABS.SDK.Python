...
> EmptyEnvelope api_v2_learning_service_student_profiles_student_profile_id_patch(tenant_id, student_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_v2_learning_service_student_profiles_student_profile_id_patch(tenant_id, student_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of StudentProfilesApi->api_v2_learning_service_student_profiles_student_profile_id_patch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StudentProfilesApi->api_v2_learning_service_student_profiles_student_profile_id_patch: %s\n" % e)
```
