...
> EmptyEnvelope api_v2_learning_service_instructor_profiles_instructor_profile_id_patch(tenant_id, instructor_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_v2_learning_service_instructor_profiles_instructor_profile_id_patch(tenant_id, instructor_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of InstructorProfilesApi->api_v2_learning_service_instructor_profiles_instructor_profile_id_patch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InstructorProfilesApi->api_v2_learning_service_instructor_profiles_instructor_profile_id_patch: %s\n" % e)
```
