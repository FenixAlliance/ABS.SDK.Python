...
json = "{}"
# create an instance of StudentProfileDto from a JSON string
student_profile_dto_instance = StudentProfileDto.from_json(json)
# print the JSON string representation of the object
print(StudentProfileDto.to_json())

# convert the object into a dict
student_profile_dto_dict = student_profile_dto_instance.to_dict()
# create an instance of StudentProfileDto from a dict
student_profile_dto_from_dict = StudentProfileDto.from_dict(student_profile_dto_dict)
```
