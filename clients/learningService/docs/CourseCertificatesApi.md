...
> EmptyEnvelope patch_course_certificate_async(tenant_id, course_certificate_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a course certificate
        api_response = api_instance.patch_course_certificate_async(tenant_id, course_certificate_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CourseCertificatesApi->patch_course_certificate_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CourseCertificatesApi->patch_course_certificate_async: %s\n" % e)
```
...
> EmptyEnvelope patch_course_certificate_template_async(tenant_id, course_certificate_template_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a certificate template
        api_response = api_instance.patch_course_certificate_template_async(tenant_id, course_certificate_template_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CourseCertificatesApi->patch_course_certificate_template_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CourseCertificatesApi->patch_course_certificate_template_async: %s\n" % e)
```
