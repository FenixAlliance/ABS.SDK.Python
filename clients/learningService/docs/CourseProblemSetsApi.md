...
> EmptyEnvelope patch_course_problem_set_async(tenant_id, problem_set_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a course problem set
        api_response = api_instance.patch_course_problem_set_async(tenant_id, problem_set_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CourseProblemSetsApi->patch_course_problem_set_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CourseProblemSetsApi->patch_course_problem_set_async: %s\n" % e)
```
