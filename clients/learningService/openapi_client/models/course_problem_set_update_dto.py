...
class CourseProblemSetUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "overallScore", "courseUnitId", "courseGradingRubricId", "releaseDateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if course_grading_rubric_id (nullable) is None
        # and model_fields_set contains the field
        if self.course_grading_rubric_id is None and "course_grading_rubric_id" in self.model_fields_set:
            _dict['courseGradingRubricId'] = None
