...
class CourseTeamMembershipDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "courseId", "instructorProfileId", "courseTeamMembershipType", "tenantId", "enrollmentId"]
