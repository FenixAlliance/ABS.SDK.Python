...
class CourseCertificateTemplateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "courseId", "tenantId", "webPortalId", "websiteThemeId", "enrollmentId", "socialProfileId", "parentWebContentId", "parentWebContentVersionId"]
