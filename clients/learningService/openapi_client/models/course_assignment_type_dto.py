...
class CourseAssignmentTypeDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "abbreviation", "weight", "quantity", "excluded", "courseId", "tenantId", "enrollmentId"]
