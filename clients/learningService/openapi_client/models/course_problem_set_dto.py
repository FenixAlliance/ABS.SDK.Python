...
class CourseProblemSetDto(BaseModel):
    """
    CourseProblemSetDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "overallScore", "courseId", "courseUnitId", "courseGradingRubricId", "releaseDateTime", "tenantId", "enrollmentId"]
