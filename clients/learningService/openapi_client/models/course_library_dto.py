...
class CourseLibraryDto(BaseModel):
    """
    CourseLibraryDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "courseId", "courseUnitId", "releaseDateTime", "tenantId", "enrollmentId"]
