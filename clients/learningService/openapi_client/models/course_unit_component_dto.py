...
class CourseUnitComponentDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "content", "order", "courseId", "courseUnitId", "tenantId", "enrollmentId"]
