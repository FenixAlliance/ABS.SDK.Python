...
class CourseCohortUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "startDateTime", "endDateTime", "expectedStartDateTime", "expectedEndDateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if expected_start_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.expected_start_date_time is None and "expected_start_date_time" in self.model_fields_set:
            _dict['expectedStartDateTime'] = None

        # set to None if expected_end_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.expected_end_date_time is None and "expected_end_date_time" in self.model_fields_set:
            _dict['expectedEndDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expectedEndDateTime": obj.get("expectedEndDateTime")
        })
        return _obj
