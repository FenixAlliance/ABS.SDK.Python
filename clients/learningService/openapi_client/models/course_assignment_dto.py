...
class CourseAssignmentDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "instructions", "points", "dueDateTime", "courseId", "courseUnitId", "courseSectionId", "courseCohortId", "courseAssignmentTypeId", "asignToAllCohorts", "resources", "tenantId", "enrollmentId"]
