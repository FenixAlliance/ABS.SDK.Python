...
class CourseCompletionCertificateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "studentProfileId", "courseEnrollmentId", "tenantId", "enrollmentId", "courseCompletionCertificateTemplateId", "courseId", "studentName", "studentLastName", "courseTitle", "totalEffortInHours", "instructorName", "instructorLastName"]
