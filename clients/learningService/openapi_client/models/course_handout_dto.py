...
class CourseHandoutDto(BaseModel):
    """
    CourseHandoutDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "content", "url", "releaseDateTime", "courseId", "courseUnitId", "tenantId", "enrollmentId"]
