...
class CourseSectionDto(BaseModel):
    """
    CourseSectionDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "icon", "name", "description", "courseId", "releaseDateTime", "hideFromStudents", "tenantId", "enrollmentId"]
