...
class CourseWikiDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "releaseDateTime", "tenantId", "enrollmentId", "courseId", "courseUnitId"]
