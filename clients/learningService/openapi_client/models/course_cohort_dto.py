...
class CourseCohortDto(BaseModel):
    """
    CourseCohortDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "startDateTime", "endDateTime", "expectedStartDateTime", "expectedEndDateTime", "courseId", "tenantId", "enrollmentId"]
