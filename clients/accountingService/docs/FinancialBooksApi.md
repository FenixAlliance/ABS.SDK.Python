...
> EmptyEnvelope patch_financial_book_async(tenant_id, financial_book_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a financial book
        api_response = api_instance.patch_financial_book_async(tenant_id, financial_book_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of FinancialBooksApi->patch_financial_book_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FinancialBooksApi->patch_financial_book_async: %s\n" % e)
```
