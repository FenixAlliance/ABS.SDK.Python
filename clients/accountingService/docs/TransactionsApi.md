...
# **patch_transaction**
> EmptyEnvelope patch_transaction(tenant_id, transaction_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a transaction
        api_response = api_instance.patch_transaction(tenant_id, transaction_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TransactionsApi->patch_transaction:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TransactionsApi->patch_transaction: %s\n" % e)
```
...
> EmptyEnvelope patch_transaction_category(tenant_id, category_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a transaction category
        api_response = api_instance.patch_transaction_category(tenant_id, category_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TransactionsApi->patch_transaction_category:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TransactionsApi->patch_transaction_category: %s\n" % e)
```
