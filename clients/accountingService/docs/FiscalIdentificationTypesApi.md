...
> EmptyEnvelope patch_fiscal_identification_type_async(tenant_id, identification_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a fiscal identification type
        api_response = api_instance.patch_fiscal_identification_type_async(tenant_id, identification_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of FiscalIdentificationTypesApi->patch_fiscal_identification_type_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FiscalIdentificationTypesApi->patch_fiscal_identification_type_async: %s\n" % e)
```
