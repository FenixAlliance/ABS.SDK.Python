...
> EmptyEnvelope patch_fiscal_authority_async(tenant_id, authority_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a fiscal authority
        api_response = api_instance.patch_fiscal_authority_async(tenant_id, authority_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of FiscalAuthoritiesApi->patch_fiscal_authority_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FiscalAuthoritiesApi->patch_fiscal_authority_async: %s\n" % e)
```
