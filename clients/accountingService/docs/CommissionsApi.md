...
> EmptyEnvelope patch_commission_async(tenant_id, commission_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a commission
        api_response = api_instance.patch_commission_async(tenant_id, commission_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CommissionsApi->patch_commission_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommissionsApi->patch_commission_async: %s\n" % e)
```
...
> EmptyEnvelope patch_payment_commission_async(tenant_id, payment_commission_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a payment commission
        api_response = api_instance.patch_payment_commission_async(tenant_id, payment_commission_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of CommissionsApi->patch_payment_commission_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommissionsApi->patch_payment_commission_async: %s\n" % e)
```
