...
> EmptyEnvelope patch_fiscal_responsibility_record_async(tenant_id, fiscal_responsibility_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a fiscal responsibility record
        api_response = api_instance.patch_fiscal_responsibility_record_async(tenant_id, fiscal_responsibility_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of FiscalResponsibilityRecordsApi->patch_fiscal_responsibility_record_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FiscalResponsibilityRecordsApi->patch_fiscal_responsibility_record_async: %s\n" % e)
```
