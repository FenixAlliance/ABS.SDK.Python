...
> EmptyEnvelope patch_applied_tax_policy_record(tenant_id, tax_policy_id, applied_tax_policy_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an applied tax policy record
        api_response = api_instance.patch_applied_tax_policy_record(tenant_id, tax_policy_id, applied_tax_policy_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TaxPoliciesApi->patch_applied_tax_policy_record:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxPoliciesApi->patch_applied_tax_policy_record: %s\n" % e)
```
...
> EmptyEnvelope patch_item_tax_policy_record(tenant_id, tax_policy_id, item_tax_policy_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item tax policy record
        api_response = api_instance.patch_item_tax_policy_record(tenant_id, tax_policy_id, item_tax_policy_record_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TaxPoliciesApi->patch_item_tax_policy_record:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxPoliciesApi->patch_item_tax_policy_record: %s\n" % e)
```
...
# **patch_tax_policy**
> EmptyEnvelope patch_tax_policy(tenant_id, id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a tax policy
        api_response = api_instance.patch_tax_policy(tenant_id, id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TaxPoliciesApi->patch_tax_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TaxPoliciesApi->patch_tax_policy: %s\n" % e)
```
