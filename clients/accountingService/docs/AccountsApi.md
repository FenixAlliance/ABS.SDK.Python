...
> EmptyEnvelope patch_account_entry_async(tenant_id, account_id, entry_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch account entry
        api_response = api_instance.patch_account_entry_async(tenant_id, account_id, entry_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of AccountsApi->patch_account_entry_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountsApi->patch_account_entry_async: %s\n" % e)
```
...
> EmptyEnvelope patch_account_relation_async(tenant_id, account_relation_id, account_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch account relation
        api_response = api_instance.patch_account_relation_async(tenant_id, account_relation_id, account_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of AccountsApi->patch_account_relation_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountsApi->patch_account_relation_async: %s\n" % e)
```
...
> EmptyEnvelope patch_account_type_async(tenant_id, account_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch account type
        api_response = api_instance.patch_account_type_async(tenant_id, account_type_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of AccountsApi->patch_account_type_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountsApi->patch_account_type_async: %s\n" % e)
```
