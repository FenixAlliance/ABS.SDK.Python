...
class TestAccountingPeriodDto(unittest.TestCase):
    """AccountingPeriodDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingPeriodDto:
        """Test AccountingPeriodDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingPeriodDto`
        """
        model = AccountingPeriodDto()
        if include_optional:
    ...
    def testAccountingPeriodDto(self):
        """Test AccountingPeriodDto"""
