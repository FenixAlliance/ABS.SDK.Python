...
class TestFiscalPeriodDto(unittest.TestCase):
    """FiscalPeriodDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FiscalPeriodDto:
        """Test FiscalPeriodDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FiscalPeriodDto`
        """
        model = FiscalPeriodDto()
        if include_optional:
