...
class TaxRatesApi:
    ...
    def create_tax_rate(
        ...
        tax_rate_create_dto: Optional[TaxRateCreateDto] = None,
        ...
        :param tax_rate_create_dto:
        :type tax_rate_create_dto: TaxRateCreateDto
        ...
        _param = self._create_tax_rate_serialize(
            ...
            tax_rate_create_dto=tax_rate_create_dto,
    ...
    def _create_tax_rate_serialize(
        ...
        if tax_rate_create_dto is not None:
            _body_params = tax_rate_create_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/AccountingService/TaxRates',
    ...
    def _delete_tax_rate_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/AccountingService/TaxRates/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tax_rate_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaxRateDtoEnvelope]:
        """Get tax rate by ID
    ...
    def get_tax_rates_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaxRateDtoListEnvelope]:
        """Get all tax rates for a tenant
    ...
    def get_tax_rates_count(
        ...
        _param = self._get_tax_rates_count_serialize(
            tenant_id=tenant_id,
            api_version=api_version,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_tax_rates_count_with_http_info(
        self,
        tenant_id: StrictStr,
        api_version: Optional[StrictStr] = None,
        x_api_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_tax_rates_count_without_preload_content(
        self,
        tenant_id: StrictStr,
        api_version: Optional[StrictStr] = None,
        x_api_version: Optional[StrictStr] = None,
    ...
    def _get_tax_rates_count_serialize(
        self,
        tenant_id,
        api_version,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/AccountingService/TaxRates/Count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_tax_rate(
        ...
        _param = self._patch_tax_rate_serialize(
            tenant_id=tenant_id,
            id=id,
            api_version=api_version,
            x_api_version=x_api_version,
    ...
    @validate_call
    def patch_tax_rate_with_http_info(
        self,
        tenant_id: StrictStr,
        id: StrictStr,
        api_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def patch_tax_rate_without_preload_content(
        self,
        tenant_id: StrictStr,
        id: StrictStr,
        api_version: Optional[StrictStr] = None,
    ...
    def update_tax_rate(
        ...
        api_version: Optional[StrictStr] = None,
        x_api_version: Optional[StrictStr] = None,
        tax_rate_update_dto: Optional[TaxRateUpdateDto] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_api_version:
        :type x_api_version: str
        :param tax_rate_update_dto:
        :type tax_rate_update_dto: TaxRateUpdateDto
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_tax_rate_serialize(
            ...
            api_version=api_version,
            x_api_version=x_api_version,
            tax_rate_update_dto=tax_rate_update_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_tax_rate_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if tax_rate_update_dto is not None:
            _body_params = tax_rate_update_dto
