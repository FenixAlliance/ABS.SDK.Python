...
class FiscalAuthorityYearsApi:
    ...
    def create_fiscal_year(
        ...
        _param = self._create_fiscal_year_serialize(
            tenant_id=tenant_id,
    ...
    def _create_fiscal_year_serialize(
        self,
        tenant_id,
        api_version,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/AccountingService/Fiscals/Authorities/FiscalYears',
    ...
    def delete_fiscal_year(
        ...
        _param = self._delete_fiscal_year_serialize(
            tenant_id=tenant_id,
    ...
    def _delete_fiscal_year_serialize(
        self,
        tenant_id,
        fiscal_year_id,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/AccountingService/Fiscals/Authorities/FiscalYears/{fiscalYearId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_fiscal_year_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/{fiscalYearId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_fiscal_years(
        ...
        _param = self._get_fiscal_years_serialize(
            tenant_id=tenant_id,
            fiscal_authority_id=fiscal_authority_id,
    ...
    def get_fiscal_years_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FiscalYearDtoListEnvelope]:
        """Get fiscal years for an authority
    ...
    def _get_fiscal_years_serialize(
        self,
        tenant_id,
        fiscal_authority_id,
        authority_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/AccountingService/Fiscals/Authorities/{authorityId}/FiscalYears',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_fiscal_years_count(
        ...
        _param = self._get_fiscal_years_count_serialize(
            tenant_id=tenant_id,
            fiscal_authority_id=fiscal_authority_id,
            api_version=api_version,
            x_api_version=x_api_version,
    ...
    def _get_fiscal_years_count_serialize(
        self,
        tenant_id,
        fiscal_authority_id,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/Count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_fiscal_authority_year_async(
        self,
        tenant_id: StrictStr,
        fiscal_year_id: StrictStr,
        api_version: Optional[StrictStr] = None,
        ...
        _param = self._patch_fiscal_authority_year_async_serialize(
            tenant_id=tenant_id,
            fiscal_year_id=fiscal_year_id,
            api_version=api_version,
            x_api_version=x_api_version,
    ...
    @validate_call
    def patch_fiscal_authority_year_async_with_http_info(
        self,
        tenant_id: StrictStr,
        fiscal_year_id: StrictStr,
        api_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def patch_fiscal_authority_year_async_without_preload_content(
        self,
        tenant_id: StrictStr,
        fiscal_year_id: StrictStr,
        api_version: Optional[StrictStr] = None,
    ...
    def _patch_fiscal_authority_year_async_serialize(
        self,
        tenant_id,
        fiscal_year_id,
        api_version,
    ...
    def update_fiscal_year(
        ...
        _param = self._update_fiscal_year_serialize(
            tenant_id=tenant_id,
            fiscal_year_id=fiscal_year_id,
            api_version=api_version,
            x_api_version=x_api_version,
    ...
    def _update_fiscal_year_serialize(
        self,
        tenant_id,
        fiscal_year_id,
        api_version,
