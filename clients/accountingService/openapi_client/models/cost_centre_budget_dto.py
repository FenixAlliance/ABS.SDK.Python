...
class CostCentreBudgetDto(BaseModel):
    """
    CostCentreBudgetDto
    """ # noqa: E501
    ...
    cost_centre_id: Optional[StrictStr] = Field(default=None, alias="costCentreId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cost_centre_id (nullable) is None
        # and model_fields_set contains the field
        if self.cost_centre_id is None and "cost_centre_id" in self.model_fields_set:
            _dict['costCentreId'] = None
