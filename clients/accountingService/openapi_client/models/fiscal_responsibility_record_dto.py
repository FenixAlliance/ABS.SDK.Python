...
class FiscalResponsibilityRecordDto(BaseModel):
    """
    FiscalResponsibilityRecordDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    fiscal_responsibility_id: Optional[StrictStr] = Field(default=None, alias="fiscalResponsibilityId")
    billing_profile_id: Optional[StrictStr] = Field(default=None, alias="billingProfileId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if fiscal_responsibility_id (nullable) is None
        # and model_fields_set contains the field
        if self.fiscal_responsibility_id is None and "fiscal_responsibility_id" in self.model_fields_set:
            _dict['fiscalResponsibilityId'] = None

        # set to None if billing_profile_id (nullable) is None
        # and model_fields_set contains the field
