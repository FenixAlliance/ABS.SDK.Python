...
class TaxClassDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "tenantId", "type", "enrollmentId", "fiscalAuthorityId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Tax', 'Withholding']):
            raise ValueError("must be one of enum values ('Tax', 'Withholding')")
        return value
