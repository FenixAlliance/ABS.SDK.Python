...
class BankTransactionDto(BaseModel):
    ...
    external_description: Optional[StrictStr] = Field(default=None, alias="externalDescription")
    ...
    transaction_category_id: Optional[StrictStr] = Field(default=None, alias="transactionCategoryId")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "description", "price", "quantity", "externalDescription", "basisQuantity", "basisAmount", "percent", "unitGroupId", "unitId", "transactionCategoryId", "currencyId", "tenantId", "enrollmentId", "bankProfileId", "bankAccountId"]
