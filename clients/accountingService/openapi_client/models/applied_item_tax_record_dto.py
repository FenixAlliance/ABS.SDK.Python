...
class AppliedItemTaxRecordDto(BaseModel):
    """
    ...
    billing_item_record_id: Optional[StrictStr] = Field(default=None, alias="billingItemRecordId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD", "billingItemRecordId"]
