...
class AppliedTaxPolicyRecordCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD"]
