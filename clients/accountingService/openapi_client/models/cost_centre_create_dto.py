...
class CostCentreCreateDto(BaseModel):
    """
    CostCentreCreateDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "disabled", "description", "costCentreType", "costCentresGroupId", "parentCostCentreId"]
