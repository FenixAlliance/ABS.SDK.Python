...
class CreateLedgerDto(BaseModel):
    """
    CreateLedgerDto
    """ # noqa: E501
    ...
    ledger_type_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="ledgerTypeId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "dateTime", "tenantId", "enrollmentId", "ledgerTypeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ledger_type_id (nullable) is None
        # and model_fields_set contains the field
        if self.ledger_type_id is None and "ledger_type_id" in self.model_fields_set:
            _dict['ledgerTypeId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ledgerTypeId": obj.get("ledgerTypeId")
        })
        return _obj
