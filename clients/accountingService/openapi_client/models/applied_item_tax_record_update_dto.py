...
class AppliedItemTaxRecordUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD", "billingItemRecordId"]
