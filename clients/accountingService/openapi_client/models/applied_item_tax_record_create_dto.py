...
class AppliedItemTaxRecordCreateDto(BaseModel):
    """
    ...
    billing_item_record_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="billingItemRecordId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "taxPolicyId", "invoiceId", "itemId", "taxAmountInUSD", "taxBaseAmountInUSD", "billingItemRecordId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if billing_item_record_id (nullable) is None
        # and model_fields_set contains the field
        if self.billing_item_record_id is None and "billing_item_record_id" in self.model_fields_set:
            _dict['billingItemRecordId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billingItemRecordId": obj.get("billingItemRecordId")
        })
        return _obj
