...
class LedgerTypeUpdateDto(BaseModel):
    """
    LedgerTypeUpdateDto
    """ # noqa: E501
    ...
    def ledger_class_validate_enum(cls, value):
        ...
        if value not in set(['Assets', 'Equity', 'Gains', 'Losses', 'Revenue', 'Expenses', 'Liabilities']):
            raise ValueError("must be one of enum values ('Assets', 'Equity', 'Gains', 'Losses', 'Revenue', 'Expenses', 'Liabilities')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ledger_class (nullable) is None
        # and model_fields_set contains the field
