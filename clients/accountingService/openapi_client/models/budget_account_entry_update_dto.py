...
class BudgetAccountEntryUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "enrollmentId", "description", "amount", "date", "currencyId", "debitAccountId", "creditAccountId", "journalEntryId", "accountingEntryType", "budgetId"]
