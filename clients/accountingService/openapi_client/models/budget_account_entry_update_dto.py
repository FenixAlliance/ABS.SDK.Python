...
class BudgetAccountEntryUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "amount", "date", "currencyId", "debitAccountId", "creditAccountId", "journalEntryId", "accountingEntryType", "budgetId"]
