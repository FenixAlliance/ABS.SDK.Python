...
class AccountDto(BaseModel):
    ...
    debits_balance_in_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="debitsBalanceInUsd")
    credits_balance_in_usd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="creditsBalanceInUsd")
    ...
    balance_amount_in_usd: Optional[Money] = Field(default=None, alias="balanceAmountInUsd")
    debits_balance_amount_in_usd: Optional[Money] = Field(default=None, alias="debitsBalanceAmountInUsd")
    credits_balance_amount_in_usd: Optional[Money] = Field(default=None, alias="creditsBalanceAmountInUsd")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "group", "frozen", "name", "code", "path", "title", "prefix", "balance", "currencyId", "accountType", "qualifiedName", "accountTypeId", "debitsBalance", "creditsBalance", "balanceInUsd", "debitsBalanceInUsd", "creditsBalanceInUsd", "forexRate", "parentAccountId", "tenantId", "enrollmentId", "childrenAccountsCount", "accountCategory", "balanceAmount", "creditsBalanceAmount", "debitsBalanceAmount", "balanceAmountInUsd", "debitsBalanceAmountInUsd", "creditsBalanceAmountInUsd"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of balance_amount_in_usd
        if self.balance_amount_in_usd:
            _dict['balanceAmountInUsd'] = self.balance_amount_in_usd.to_dict()
        # override the default output from pydantic by calling `to_dict()` of debits_balance_amount_in_usd
        if self.debits_balance_amount_in_usd:
            _dict['debitsBalanceAmountInUsd'] = self.debits_balance_amount_in_usd.to_dict()
        # override the default output from pydantic by calling `to_dict()` of credits_balance_amount_in_usd
        if self.credits_balance_amount_in_usd:
            _dict['creditsBalanceAmountInUsd'] = self.credits_balance_amount_in_usd.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debitsBalanceInUsd": obj.get("debitsBalanceInUsd"),
            "creditsBalanceInUsd": obj.get("creditsBalanceInUsd"),
            ...
            "balanceAmountInUsd": Money.from_dict(obj["balanceAmountInUsd"]) if obj.get("balanceAmountInUsd") is not None else None,
            "debitsBalanceAmountInUsd": Money.from_dict(obj["debitsBalanceAmountInUsd"]) if obj.get("debitsBalanceAmountInUsd") is not None else None,
            "creditsBalanceAmountInUsd": Money.from_dict(obj["creditsBalanceAmountInUsd"]) if obj.get("creditsBalanceAmountInUsd") is not None else None
        })
        return _obj
