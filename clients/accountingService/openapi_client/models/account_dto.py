...
class AccountDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "group", "frozen", "name", "code", "path", "title", "prefix", "balance", "currencyId", "accountType", "qualifiedName", "accountTypeId", "debitsBalance", "creditsBalance", "parentAccountId", "tenantId", "enrollmentId", "childrenAccountsCount", "accountCategory", "balanceAmount", "creditsBalanceAmount", "debitsBalanceAmount"]
