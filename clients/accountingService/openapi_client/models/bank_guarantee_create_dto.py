...
class BankGuaranteeCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "margin", "charges", "beneficiaryName", "guaranteeNumber", "guaranteeConditions", "fixedDepositNumber", "startDate", "endDate", "validityInDays", "bankGuaranteeType", "contactId", "projectId", "orderId", "bankProfileId", "bankAccountId", "currencyId"]
