...
class ItemTaxPolicyRecordDtoEnvelope(BaseModel):
    """
    ...
    result: Optional[ItemTaxPolicyRecordDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": ItemTaxPolicyRecordDto.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
