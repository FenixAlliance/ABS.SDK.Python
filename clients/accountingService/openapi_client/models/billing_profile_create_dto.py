...
class BillingProfileCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "contactId", "taxId", "phone", "email", "address", "address1", "address2", "postalCode", "businessName", "commercialName", "ticker", "duns", "isPublicCompany", "isFactaCustomer", "taxPayerType", "countryId", "stateId", "cityId", "fiscalIdentificationTypeId", "fiscalAuthorityId", "fiscalRegimeId"]
