...
class TransactionCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "description", "price", "quantity", "externalDescription", "basisQuantity", "basisAmount", "percent", "unitGroupId", "unitId", "transactionCategoryId", "currencyId", "tenantId", "enrollmentId"]
