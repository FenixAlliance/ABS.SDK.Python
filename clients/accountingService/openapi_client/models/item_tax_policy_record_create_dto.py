...
class ItemTaxPolicyRecordCreateDto(BaseModel):
    """
    ...
    item_price_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="itemPriceId")
    item_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="itemId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "taxPolicyId", "itemPriceId", "itemId"]
