...
class LoanDto(BaseModel):
    ...
    loan_timestamp: Optional[datetime] = Field(default=None, alias="loanTimestamp")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if loan_type_id (nullable) is None
        # and model_fields_set contains the field
        if self.loan_type_id is None and "loan_type_id" in self.model_fields_set:
            _dict['loanTypeId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loanTimestamp": obj.get("loanTimestamp"),
