...
class CommissionCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "baseAmount", "addedPercent", "addedAmount", "taxComission", "salaryId", "emisorWalletAccountId", "receiverWalletAccountId", "emisorContactId", "receiverContactId"]
