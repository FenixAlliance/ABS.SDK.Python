...
class BankAccountUpdateDto(BaseModel):
    """
    ...
    wallet_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=36)]] = Field(default=None, alias="walletId")
    __properties: ClassVar[List[str]] = ["name", "iban", "swift", "branchCode", "bankAccountNumber", "bankId", "bankProfileId", "walletId"]
