...
class CostCentreGroupDto(BaseModel):
    """
    CostCentreGroupDto
    """ # noqa: E501
    ...
    parent_cost_centres_group_id: Optional[StrictStr] = Field(default=None, alias="parentCostCentresGroupId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.parent_cost_centres_group_id is None and "parent_cost_centres_group_id" in self.model_fields_set:
            _dict['parentCostCentresGroupId'] = None
