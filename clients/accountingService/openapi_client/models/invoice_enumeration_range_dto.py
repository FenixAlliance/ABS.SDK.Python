...
class InvoiceEnumerationRangeDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "prefix", "suffix", "identifier", "qualifiedName", "currentNumeration", "numerationTo", "numerationFrom", "validFrom", "validTo", "fiscalAuthorityId", "tenantId", "enrollmentId", "documentType"]
