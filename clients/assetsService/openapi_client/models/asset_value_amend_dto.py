...
class AssetValueAmendDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "assetId", "assetName", "previousValue", "newValue", "amendmentAmount", "reason", "amendmentDate", "currencyId"]
