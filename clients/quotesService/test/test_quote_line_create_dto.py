...
class TestQuoteLineCreateDto(unittest.TestCase):
    """QuoteLineCreateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLineCreateDto:
        """Test QuoteLineCreateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLineCreateDto`
        """
        model = QuoteLineCreateDto()
        if include_optional:
            return QuoteLineCreateDto(
                id = '',
    ...
    def testQuoteLineCreateDto(self):
        """Test QuoteLineCreateDto"""
