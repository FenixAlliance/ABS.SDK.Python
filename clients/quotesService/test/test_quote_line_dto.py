...
class TestQuoteLineDto(unittest.TestCase):
    """QuoteLineDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLineDto:
        """Test QuoteLineDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLineDto`
        """
        model = QuoteLineDto()
        if include_optional:
            return QuoteLineDto(
