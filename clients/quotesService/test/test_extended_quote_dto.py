...
class TestExtendedQuoteDto(unittest.TestCase):
    """ExtendedQuoteDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedQuoteDto:
        """Test ExtendedQuoteDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedQuoteDto`
        """
        model = ExtendedQuoteDto()
        if include_optional:
            return ExtendedQuoteDto(
                id = '',
