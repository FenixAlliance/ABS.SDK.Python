...
class TestQuoteLineUpdateDto(unittest.TestCase):
    """QuoteLineUpdateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLineUpdateDto:
        """Test QuoteLineUpdateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLineUpdateDto`
        """
        model = QuoteLineUpdateDto()
        if include_optional:
            return QuoteLineUpdateDto(
                closed = True,
                item_id = '',
                item_title = '',
    ...
    def testQuoteLineUpdateDto(self):
        """Test QuoteLineUpdateDto"""
