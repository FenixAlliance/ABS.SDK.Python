...
class TestQuoteLineDtoEnvelope(unittest.TestCase):
    """QuoteLineDtoEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLineDtoEnvelope:
        """Test QuoteLineDtoEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLineDtoEnvelope`
        """
        model = QuoteLineDtoEnvelope()
        if include_optional:
            return QuoteLineDtoEnvelope(
                ...
                activity_id = '',
                result = openapi_client.models.quote_line_dto.QuoteLineDto(
                    id = '', 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed = True, 
                    item_id = '', 
    ...
    def testQuoteLineDtoEnvelope(self):
        """Test QuoteLineDtoEnvelope"""
