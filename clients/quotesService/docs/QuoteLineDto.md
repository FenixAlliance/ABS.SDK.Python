...
json = "{}"
# create an instance of QuoteLineDto from a JSON string
quote_line_dto_instance = QuoteLineDto.from_json(json)
# print the JSON string representation of the object
print(QuoteLineDto.to_json())

# convert the object into a dict
quote_line_dto_dict = quote_line_dto_instance.to_dict()
# create an instance of QuoteLineDto from a dict
quote_line_dto_from_dict = QuoteLineDto.from_dict(quote_line_dto_dict)
```
