...
json = "{}"
# create an instance of QuoteLineCreateDto from a JSON string
quote_line_create_dto_instance = QuoteLineCreateDto.from_json(json)
# print the JSON string representation of the object
print(QuoteLineCreateDto.to_json())

# convert the object into a dict
quote_line_create_dto_dict = quote_line_create_dto_instance.to_dict()
# create an instance of QuoteLineCreateDto from a dict
quote_line_create_dto_from_dict = QuoteLineCreateDto.from_dict(quote_line_create_dto_dict)
```
