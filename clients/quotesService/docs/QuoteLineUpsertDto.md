...
json = "{}"
# create an instance of QuoteLineUpsertDto from a JSON string
quote_line_upsert_dto_instance = QuoteLineUpsertDto.from_json(json)
# print the JSON string representation of the object
print(QuoteLineUpsertDto.to_json())

# convert the object into a dict
quote_line_upsert_dto_dict = quote_line_upsert_dto_instance.to_dict()
# create an instance of QuoteLineUpsertDto from a dict
quote_line_upsert_dto_from_dict = QuoteLineUpsertDto.from_dict(quote_line_upsert_dto_dict)
```
