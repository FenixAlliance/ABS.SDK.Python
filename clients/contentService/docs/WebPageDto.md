...
web_page_dto_instance = WebPageDto.from_json(json)
# print the JSON string representation of the object
print(WebPageDto.to_json())

# convert the object into a dict
web_page_dto_dict = web_page_dto_instance.to_dict()
# create an instance of WebPageDto from a dict
web_page_dto_from_dict = WebPageDto.from_dict(web_page_dto_dict)
```
