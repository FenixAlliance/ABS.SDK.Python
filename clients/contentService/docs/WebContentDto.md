...
json = "{}"
# create an instance of WebContentDto from a JSON string
web_content_dto_instance = WebContentDto.from_json(json)
# print the JSON string representation of the object
print(WebContentDto.to_json())

# convert the object into a dict
web_content_dto_dict = web_content_dto_instance.to_dict()
# create an instance of WebContentDto from a dict
web_content_dto_from_dict = WebContentDto.from_dict(web_content_dto_dict)
```
