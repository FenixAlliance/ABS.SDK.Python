...
json = "{}"
# create an instance of WebContentUpdateDto from a JSON string
web_content_update_dto_instance = WebContentUpdateDto.from_json(json)
# print the JSON string representation of the object
print(WebContentUpdateDto.to_json())

# convert the object into a dict
web_content_update_dto_dict = web_content_update_dto_instance.to_dict()
# create an instance of WebContentUpdateDto from a dict
web_content_update_dto_from_dict = WebContentUpdateDto.from_dict(web_content_update_dto_dict)
```
