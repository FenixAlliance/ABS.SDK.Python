...
**is_blog_page** | **bool** |  | [optional] 
**is_account_page** | **bool** |  | [optional] 
**is_checkout_page** | **bool** |  | [optional] 
**is_wish_lists_page** | **bool** |  | [optional] 
**is_contact_page** | **bool** |  | [optional] 
**is_privacy_policy_page** | **bool** |  | [optional] 
**is_terms_of_service_page** | **bool** |  | [optional] 
...
json = "{}"
# create an instance of WebPageUpdateDto from a JSON string
web_page_update_dto_instance = WebPageUpdateDto.from_json(json)
# print the JSON string representation of the object
print(WebPageUpdateDto.to_json())

# convert the object into a dict
web_page_update_dto_dict = web_page_update_dto_instance.to_dict()
# create an instance of WebPageUpdateDto from a dict
web_page_update_dto_from_dict = WebPageUpdateDto.from_dict(web_page_update_dto_dict)
```
