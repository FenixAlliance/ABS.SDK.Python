...
> Int32Envelope count_web_page_tags_async(tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Count web page tags
        api_response = api_instance.count_web_page_tags_async(tenant_id, api_version=api_version, x_api_version=x_api_version)
        print("The response of WebPageTagsApi->count_web_page_tags_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebPageTagsApi->count_web_page_tags_async: %s\n" % e)
```
...
> EmptyEnvelope patch_web_page_tag_async(tenant_id, web_page_tag_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a web page tag
        api_response = api_instance.patch_web_page_tag_async(tenant_id, web_page_tag_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of WebPageTagsApi->patch_web_page_tag_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebPageTagsApi->patch_web_page_tag_async: %s\n" % e)
```
