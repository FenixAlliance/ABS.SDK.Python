...
class TypeInfo(BaseModel):
    ...
    generic_type_parameters: Optional[List[Type]] = Field(default=None, alias="genericTypeParameters")
    declared_constructors: Optional[List[ConstructorInfo]] = Field(default=None, alias="declaredConstructors")
    declared_events: Optional[List[EventInfo]] = Field(default=None, alias="declaredEvents")
    declared_fields: Optional[List[FieldInfo]] = Field(default=None, alias="declaredFields")
    declared_members: Optional[List[MemberInfo]] = Field(default=None, alias="declaredMembers")
    declared_methods: Optional[List[MethodInfo]] = Field(default=None, alias="declaredMethods")
    declared_nested_types: Optional[List[TypeInfo]] = Field(default=None, alias="declaredNestedTypes")
    declared_properties: Optional[List[PropertyInfo]] = Field(default=None, alias="declaredProperties")
    implemented_interfaces: Optional[List[Type]] = Field(default=None, alias="implementedInterfaces")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in generic_type_parameters (list)
        _items = []
        if self.generic_type_parameters:
            for _item_generic_type_parameters in self.generic_type_parameters:
                if _item_generic_type_parameters:
                    _items.append(_item_generic_type_parameters.to_dict())
            _dict['genericTypeParameters'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_constructors (list)
        _items = []
        if self.declared_constructors:
            for _item_declared_constructors in self.declared_constructors:
                if _item_declared_constructors:
                    _items.append(_item_declared_constructors.to_dict())
            _dict['declaredConstructors'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_events (list)
        _items = []
        if self.declared_events:
            for _item_declared_events in self.declared_events:
                if _item_declared_events:
                    _items.append(_item_declared_events.to_dict())
            _dict['declaredEvents'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_fields (list)
        _items = []
        if self.declared_fields:
            for _item_declared_fields in self.declared_fields:
                if _item_declared_fields:
                    _items.append(_item_declared_fields.to_dict())
            _dict['declaredFields'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_members (list)
        _items = []
        if self.declared_members:
            for _item_declared_members in self.declared_members:
                if _item_declared_members:
                    _items.append(_item_declared_members.to_dict())
            _dict['declaredMembers'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_methods (list)
        _items = []
        if self.declared_methods:
            for _item_declared_methods in self.declared_methods:
                if _item_declared_methods:
                    _items.append(_item_declared_methods.to_dict())
            _dict['declaredMethods'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in declared_nested_types (list)
        _items = []
        if self.declared_nested_types:
            for _item_declared_nested_types in self.declared_nested_types:
                if _item_declared_nested_types:
                    _items.append(_item_declared_nested_types.to_dict())
            _dict['declaredNestedTypes'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in implemented_interfaces (list)
        _items = []
        if self.implemented_interfaces:
            for _item_implemented_interfaces in self.implemented_interfaces:
                if _item_implemented_interfaces:
                    _items.append(_item_implemented_interfaces.to_dict())
            _dict['implementedInterfaces'] = _items
        ...
        # set to None if generic_type_parameters (nullable) is None
        # and model_fields_set contains the field
        if self.generic_type_parameters is None and "generic_type_parameters" in self.model_fields_set:
            _dict['genericTypeParameters'] = None

        # set to None if declared_constructors (nullable) is None
        # and model_fields_set contains the field
        if self.declared_constructors is None and "declared_constructors" in self.model_fields_set:
            _dict['declaredConstructors'] = None

        # set to None if declared_events (nullable) is None
        # and model_fields_set contains the field
        if self.declared_events is None and "declared_events" in self.model_fields_set:
            _dict['declaredEvents'] = None

        # set to None if declared_fields (nullable) is None
        # and model_fields_set contains the field
        if self.declared_fields is None and "declared_fields" in self.model_fields_set:
            _dict['declaredFields'] = None

        # set to None if declared_members (nullable) is None
        # and model_fields_set contains the field
        if self.declared_members is None and "declared_members" in self.model_fields_set:
            _dict['declaredMembers'] = None

        # set to None if declared_methods (nullable) is None
        # and model_fields_set contains the field
        if self.declared_methods is None and "declared_methods" in self.model_fields_set:
            _dict['declaredMethods'] = None

        # set to None if declared_nested_types (nullable) is None
        # and model_fields_set contains the field
        if self.declared_nested_types is None and "declared_nested_types" in self.model_fields_set:
            _dict['declaredNestedTypes'] = None
        ...
        # set to None if implemented_interfaces (nullable) is None
        # and model_fields_set contains the field
        if self.implemented_interfaces is None and "implemented_interfaces" in self.model_fields_set:
            _dict['implementedInterfaces'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genericTypeParameters": [Type.from_dict(_item) for _item in obj["genericTypeParameters"]] if obj.get("genericTypeParameters") is not None else None,
            "declaredConstructors": [ConstructorInfo.from_dict(_item) for _item in obj["declaredConstructors"]] if obj.get("declaredConstructors") is not None else None,
            "declaredEvents": [EventInfo.from_dict(_item) for _item in obj["declaredEvents"]] if obj.get("declaredEvents") is not None else None,
            "declaredFields": [FieldInfo.from_dict(_item) for _item in obj["declaredFields"]] if obj.get("declaredFields") is not None else None,
            "declaredMembers": [MemberInfo.from_dict(_item) for _item in obj["declaredMembers"]] if obj.get("declaredMembers") is not None else None,
            "declaredMethods": [MethodInfo.from_dict(_item) for _item in obj["declaredMethods"]] if obj.get("declaredMethods") is not None else None,
            "declaredNestedTypes": [TypeInfo.from_dict(_item) for _item in obj["declaredNestedTypes"]] if obj.get("declaredNestedTypes") is not None else None,
            "declaredProperties": [PropertyInfo.from_dict(_item) for _item in obj["declaredProperties"]] if obj.get("declaredProperties") is not None else None,
            "implementedInterfaces": [Type.from_dict(_item) for _item in obj["implementedInterfaces"]] if obj.get("implementedInterfaces") is not None else None
        })
        return _obj
...
TypeInfo.model_rebuild(raise_errors=False)
