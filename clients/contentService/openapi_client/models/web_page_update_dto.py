...
class WebPageUpdateDto(BaseModel):
    """
    WebPageUpdateDto
    """ # noqa: E501
    ...
    is_home_page: Optional[StrictBool] = Field(default=None, alias="isHomePage")
    is_store_page: Optional[StrictBool] = Field(default=None, alias="isStorePage")
    is_cart_page: Optional[StrictBool] = Field(default=None, alias="isCartPage")
    is_blog_page: Optional[StrictBool] = Field(default=None, alias="isBlogPage")
    is_account_page: Optional[StrictBool] = Field(default=None, alias="isAccountPage")
    is_checkout_page: Optional[StrictBool] = Field(default=None, alias="isCheckoutPage")
    is_wish_lists_page: Optional[StrictBool] = Field(default=None, alias="isWishListsPage")
    is_contact_page: Optional[StrictBool] = Field(default=None, alias="isContactPage")
    is_privacy_policy_page: Optional[StrictBool] = Field(default=None, alias="isPrivacyPolicyPage")
    is_terms_of_service_page: Optional[StrictBool] = Field(default=None, alias="isTermsOfServicePage")
    __properties: ClassVar[List[str]] = ["order", "slug", "name", "title", "excerpt", "password", "description", "highlightImage", "canonicalUrl", "seoTitle", "seoKeyWords", "seoKeyPhrases", "metaDescription", "twitterImage", "twitterTitle", "twitterDescription", "facebookImage", "facebookTitle", "facebookDescription", "featuredImageUrl", "content", "code", "namespace", "typeName", "generatedCode", "compilationPath", "htmlContent", "codeType", "cSharpContent", "razorContent", "cssContent", "jsContent", "cssFiles", "jsFiles", "razorGeneratedCode", "cSharpGeneratedCode", "precompiledLogicSize", "precompiledLogicSizeLong", "precompiledViewSize", "precompiledViewSizeLong", "precompiledLogicViewSize", "template", "default", "enable", "enableComments", "displaySocialBox", "published", "inTrashCan", "systemLocked", "allowPingbacks", "allowTrackbacks", "cornerstoneContent", "isEssentialContent", "allowSearchEngineIndexing", "webTemplateId", "parentWebContentId", "isHomePage", "isStorePage", "isCartPage", "isBlogPage", "isAccountPage", "isCheckoutPage", "isWishListsPage", "isContactPage", "isPrivacyPolicyPage", "isTermsOfServicePage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isHomePage": obj.get("isHomePage"),
            "isStorePage": obj.get("isStorePage"),
            "isCartPage": obj.get("isCartPage"),
            "isBlogPage": obj.get("isBlogPage"),
            "isAccountPage": obj.get("isAccountPage"),
            "isCheckoutPage": obj.get("isCheckoutPage"),
            "isWishListsPage": obj.get("isWishListsPage"),
            "isContactPage": obj.get("isContactPage"),
            "isPrivacyPolicyPage": obj.get("isPrivacyPolicyPage"),
            "isTermsOfServicePage": obj.get("isTermsOfServicePage")
        })
        return _obj
