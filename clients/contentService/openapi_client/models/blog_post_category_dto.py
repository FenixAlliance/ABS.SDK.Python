...
class BlogPostCategoryDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "slug", "type", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalId", "tenantId", "enrollmentId"]
