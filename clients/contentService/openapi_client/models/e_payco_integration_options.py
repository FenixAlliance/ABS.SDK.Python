...
class EPaycoIntegrationOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enable", "customerID", "customerKey", "apiKey", "apiSecret"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if customer_key (nullable) is None
        # and model_fields_set contains the field
        if self.customer_key is None and "customer_key" in self.model_fields_set:
            _dict['customerKey'] = None
