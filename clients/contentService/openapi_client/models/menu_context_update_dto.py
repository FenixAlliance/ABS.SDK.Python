...
class MenuContextUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "category", "component", "enable", "studioMenu", "customCss", "customJs", "customHtml", "loggedInOnly", "backgroundImage", "webPortalId"]
