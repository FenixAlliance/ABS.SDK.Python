...
class Assembly(BaseModel):
    ...
    code_base: Optional[StrictStr] = Field(default=None, alias="codeBase")
    ...
    escaped_code_base: Optional[StrictStr] = Field(default=None, alias="escapedCodeBase")
    manifest_module: Optional[Module] = Field(default=None, alias="manifestModule")
    modules: Optional[List[Module]] = None
    global_assembly_cache: Optional[StrictBool] = Field(default=None, alias="globalAssemblyCache")
    host_context: Optional[StrictInt] = Field(default=None, alias="hostContext")
    security_rule_set: Optional[StrictStr] = Field(default=None, alias="securityRuleSet")
    __properties: ClassVar[List[str]] = ["definedTypes", "exportedTypes", "codeBase", "entryPoint", "fullName", "imageRuntimeVersion", "isDynamic", "location", "reflectionOnly", "isCollectible", "isFullyTrusted", "customAttributes", "escapedCodeBase", "manifestModule", "modules", "globalAssemblyCache", "hostContext", "securityRuleSet"]

    @field_validator('security_rule_set')
    def security_rule_set_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['None', 'Level1', 'Level2']):
            raise ValueError("must be one of enum values ('None', 'Level1', 'Level2')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.defined_types:
            for _item_defined_types in self.defined_types:
                if _item_defined_types:
                    _items.append(_item_defined_types.to_dict())
        ...
        if self.exported_types:
            for _item_exported_types in self.exported_types:
                if _item_exported_types:
                    _items.append(_item_exported_types.to_dict())
        ...
        # set to None if code_base (nullable) is None
        # and model_fields_set contains the field
        if self.code_base is None and "code_base" in self.model_fields_set:
            _dict['codeBase'] = None
        ...
        # set to None if escaped_code_base (nullable) is None
        # and model_fields_set contains the field
        if self.escaped_code_base is None and "escaped_code_base" in self.model_fields_set:
            _dict['escapedCodeBase'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "escapedCodeBase": obj.get("escapedCodeBase"),
            ...
            "globalAssemblyCache": obj.get("globalAssemblyCache"),
