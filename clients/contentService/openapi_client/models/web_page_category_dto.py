...
class WebPageCategoryDto(BaseModel):
    """
    WebPageCategoryDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalID", "businessID", "businessProfileRecordID"]
