...
class WebPageCategoryDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalId", "tenantId", "enrollmentId"]
