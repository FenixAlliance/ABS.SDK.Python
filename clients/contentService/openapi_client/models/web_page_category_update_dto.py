...
class WebPageCategoryUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["slug", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image"]
