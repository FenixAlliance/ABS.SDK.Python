...
class MethodInfo(BaseModel):
    ...
    return_type: Optional[Type] = Field(default=None, alias="returnType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "returnType": Type.from_dict(obj["returnType"]) if obj.get("returnType") is not None else None,
...
MethodInfo.model_rebuild(raise_errors=False)
