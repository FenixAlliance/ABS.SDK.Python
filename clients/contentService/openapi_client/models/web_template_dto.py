...
class WebTemplateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "slug", "name", "title", "description", "content", "htmlContent", "cssContent", "jsContent", "razorContent", "highlightImage", "order", "tenantId", "enrollmentId"]
