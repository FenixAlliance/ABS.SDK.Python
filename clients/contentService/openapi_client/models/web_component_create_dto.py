...
class WebComponentCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "title", "description", "code", "htmlContent", "cssContent", "jsContent", "codeType", "published", "enable", "featuredImageUrl"]
