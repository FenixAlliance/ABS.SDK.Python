...
class MenuContextCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "category", "component", "enable", "studioMenu", "customCss", "customJs", "customHtml", "loggedInOnly", "backgroundImage", "webPortalId"]
