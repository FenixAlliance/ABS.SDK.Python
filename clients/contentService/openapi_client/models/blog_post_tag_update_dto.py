...
class BlogPostTagUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["slug", "type", "title", "description", "seoTitle", "metaDescription", "cornerstoneContent", "allowSerachEngines", "seoKeyPhrases", "canonicalUrl", "imageURL", "image", "webPortalID"]
