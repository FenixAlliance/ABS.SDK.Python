...
class PropertyInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "declaringType", "reflectedType", "module", "customAttributes", "isCollectible", "metadataToken", "memberType", "propertyType", "attributes", "isSpecialName", "canRead", "canWrite", "getMethod", "setMethod"]
    ...
    def attributes_validate_enum(cls, value):
        ...
        if value not in set(['None', 'SpecialName', 'RTSpecialName', 'HasDefault', 'Reserved2', 'Reserved3', 'Reserved4', 'ReservedMask']):
            raise ValueError("must be one of enum values ('None', 'SpecialName', 'RTSpecialName', 'HasDefault', 'Reserved2', 'Reserved3', 'Reserved4', 'ReservedMask')")
        return value
