...
class KeySizes(BaseModel):
    """
    KeySizes
    """ # noqa: E501
    min_size: Optional[StrictInt] = Field(default=None, alias="minSize")
    max_size: Optional[StrictInt] = Field(default=None, alias="maxSize")
    skip_size: Optional[StrictInt] = Field(default=None, alias="skipSize")
    __properties: ClassVar[List[str]] = ["minSize", "maxSize", "skipSize"]
