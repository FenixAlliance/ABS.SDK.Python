...
class BlogPostCategoryDtoEnvelope(BaseModel):
    """
    ...
    result: Optional[BlogPostCategoryDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": BlogPostCategoryDto.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
