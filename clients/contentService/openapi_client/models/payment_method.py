...
class PaymentMethod(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enable", "priority", "name", "description", "instructions", "supportedFeatures"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if supported_features (nullable) is None
        # and model_fields_set contains the field
        if self.supported_features is None and "supported_features" in self.model_fields_set:
            _dict['supportedFeatures'] = None
