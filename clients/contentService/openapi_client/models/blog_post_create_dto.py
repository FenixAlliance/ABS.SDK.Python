...
class BlogPostCreateDto(BaseModel):
    """
    BlogPostCreateDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "published", "description", "code", "markup", "featuredImageUrl", "codeType", "slug", "blogPostCategoryId", "webTemplateId"]
