...
class BlogPostCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "tenantId", "enrollmentId", "title", "code", "published", "description", "htmlContent", "featuredImageUrl", "codeType", "blogPostCategoryID", "webTemplateID"]
