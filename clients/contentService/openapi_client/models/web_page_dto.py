...
class WebPageDto(BaseModel):
    ...
    emit_result: Optional[Any] = Field(default=None, alias="emitResult")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if emit_result (nullable) is None
        # and model_fields_set contains the field
        if self.emit_result is None and "emit_result" in self.model_fields_set:
            _dict['emitResult'] = None
