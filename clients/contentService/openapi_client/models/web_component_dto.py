...
class WebComponentDto(BaseModel):
    """
    WebComponentDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "title", "description", "code", "htmlContent", "cssContent", "jsContent", "codeType", "published", "enable", "featuredImageUrl", "tenantId", "webPortalId"]
