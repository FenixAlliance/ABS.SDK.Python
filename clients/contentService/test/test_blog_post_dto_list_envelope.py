...
class TestBlogPostDtoListEnvelope(unittest.TestCase):
    """BlogPostDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlogPostDtoListEnvelope:
        """Test BlogPostDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlogPostDtoListEnvelope`
        """
        model = BlogPostDtoListEnvelope()
        if include_optional:
            return BlogPostDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.blog_post_dto.BlogPostDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        code_type = 'Razor', 
                        order = 56, 
    ...
    def testBlogPostDtoListEnvelope(self):
        """Test BlogPostDtoListEnvelope"""
