...
class TestBlogPostDto(unittest.TestCase):
    """BlogPostDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlogPostDto:
        """Test BlogPostDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlogPostDto`
        """
        model = BlogPostDto()
        if include_optional:
            return BlogPostDto(
