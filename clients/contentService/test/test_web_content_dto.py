...
class TestWebContentDto(unittest.TestCase):
    """WebContentDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebContentDto:
        """Test WebContentDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebContentDto`
        """
        model = WebContentDto()
        if include_optional:
