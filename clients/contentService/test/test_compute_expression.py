...
class TestComputeExpression(unittest.TestCase):
    """ComputeExpression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeExpression:
        """Test ComputeExpression
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeExpression`
        """
        model = ComputeExpression()
        if include_optional:
    ...
    def testComputeExpression(self):
        """Test ComputeExpression"""
