...
------------ | ------------- | ------------- | -------------
*MarginsApi* | [**api_v2_sales_service_margins_margin_id_details_get**](docs/MarginsApi.md#api_v2_sales_service_margins_margin_id_details_get) | **GET** /api/v2/SalesService/Margins/{marginId}/Details | 
