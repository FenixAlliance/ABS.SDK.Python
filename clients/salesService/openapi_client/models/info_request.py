...
class InfoRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["newEmail", "newPassword", "oldPassword"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if new_email (nullable) is None
        # and model_fields_set contains the field
        if self.new_email is None and "new_email" in self.model_fields_set:
            _dict['newEmail'] = None
