...
class Operation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["operationType", "path", "op", "from", "value"]
    ...
    def operation_type_validate_enum(cls, value):
        ...
        if value not in set(['Add', 'Remove', 'Replace', 'Move', 'Copy', 'Test', 'Invalid']):
            raise ValueError("must be one of enum values ('Add', 'Remove', 'Replace', 'Move', 'Copy', 'Test', 'Invalid')")
        return value
