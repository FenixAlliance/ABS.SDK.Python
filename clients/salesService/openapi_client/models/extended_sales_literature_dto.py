...
class ExtendedSalesLiteratureDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "content", "description", "modifiedDate", "expirationDate", "tenantId", "enrollmentId", "salesLiteratureTypeId", "salesLiteratureType", "tenant"]
