...
> EmptyEnvelope patch_sales_literature_async(tenant_id, sales_literature_id, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a sales literature
        api_response = api_instance.patch_sales_literature_async(tenant_id, sales_literature_id, operation=operation)
        print("The response of SalesLiteraturesApi->patch_sales_literature_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SalesLiteraturesApi->patch_sales_literature_async: %s\n" % e)
```
