...
class PortDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "company", "email", "address1", "address2", "address3", "unit", "customCity", "customState", "postalCode", "phone", "fax", "longitude", "latitude", "countryId", "countryStateId", "cityId", "tenantId", "enrollmentId", "unLocode", "iataCode", "portType", "portAuthority", "hasCustomsFacility", "isFreeTradezone", "isActive", "parentPortId"]
