...
class SupplierProfileUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "contactId", "about", "avatarUrl", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label"]
