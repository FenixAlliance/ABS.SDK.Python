...
class WarehouseCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "address1", "address2", "address3", "postalCode", "phone", "countryId", "stateId", "cityId", "isGroup", "shipwireWarehouseId", "parentWarehouseId"]
