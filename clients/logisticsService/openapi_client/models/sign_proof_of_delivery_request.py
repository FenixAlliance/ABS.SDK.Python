...
class SignProofOfDeliveryRequest(BaseModel):
    """
    SignProofOfDeliveryRequest
    """ # noqa: E501
    signed_by: Optional[StrictStr] = Field(default=None, alias="signedBy")
    signer_id: Optional[StrictStr] = Field(default=None, alias="signerId")
    __properties: ClassVar[List[str]] = ["signedBy", "signerId"]
