...
json = "{}"
# create an instance of RoadWaybillUpdateDto from a JSON string
road_waybill_update_dto_instance = RoadWaybillUpdateDto.from_json(json)
# print the JSON string representation of the object
print(RoadWaybillUpdateDto.to_json())

# convert the object into a dict
road_waybill_update_dto_dict = road_waybill_update_dto_instance.to_dict()
# create an instance of RoadWaybillUpdateDto from a dict
road_waybill_update_dto_from_dict = RoadWaybillUpdateDto.from_dict(road_waybill_update_dto_dict)
```
