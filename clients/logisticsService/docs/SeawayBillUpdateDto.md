...
seaway_bill_update_dto_instance = SeawayBillUpdateDto.from_json(json)
# print the JSON string representation of the object
print(SeawayBillUpdateDto.to_json())

# convert the object into a dict
seaway_bill_update_dto_dict = seaway_bill_update_dto_instance.to_dict()
# create an instance of SeawayBillUpdateDto from a dict
seaway_bill_update_dto_from_dict = SeawayBillUpdateDto.from_dict(seaway_bill_update_dto_dict)
```
