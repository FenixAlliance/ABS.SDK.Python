...
> EmptyEnvelope patch_supplier_profile_async(tenant_id, supplier_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a supplier profile
        api_response = api_instance.patch_supplier_profile_async(tenant_id, supplier_profile_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of SupplierProfilesApi->patch_supplier_profile_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SupplierProfilesApi->patch_supplier_profile_async: %s\n" % e)
```
