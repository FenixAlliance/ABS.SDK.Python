...
json = "{}"
# create an instance of RailWaybillCreateDto from a JSON string
rail_waybill_create_dto_instance = RailWaybillCreateDto.from_json(json)
# print the JSON string representation of the object
print(RailWaybillCreateDto.to_json())

# convert the object into a dict
rail_waybill_create_dto_dict = rail_waybill_create_dto_instance.to_dict()
# create an instance of RailWaybillCreateDto from a dict
rail_waybill_create_dto_from_dict = RailWaybillCreateDto.from_dict(rail_waybill_create_dto_dict)
```
