...
> EmptyEnvelope patch_rail_waybill_async(tenant_id, waybill_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a rail waybill
        api_response = api_instance.patch_rail_waybill_async(tenant_id, waybill_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of RailWaybillsApi->patch_rail_waybill_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailWaybillsApi->patch_rail_waybill_async: %s\n" % e)
```
...
> EmptyEnvelope patch_rail_waybill_line_async(tenant_id, waybill_id, line_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a rail waybill line
        api_response = api_instance.patch_rail_waybill_line_async(tenant_id, waybill_id, line_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of RailWaybillsApi->patch_rail_waybill_line_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailWaybillsApi->patch_rail_waybill_line_async: %s\n" % e)
```
