...
json = "{}"
# create an instance of AirwayBillDto from a JSON string
airway_bill_dto_instance = AirwayBillDto.from_json(json)
# print the JSON string representation of the object
print(AirwayBillDto.to_json())

# convert the object into a dict
airway_bill_dto_dict = airway_bill_dto_instance.to_dict()
# create an instance of AirwayBillDto from a dict
airway_bill_dto_from_dict = AirwayBillDto.from_dict(airway_bill_dto_dict)
```
