...
> EmptyEnvelope patch_item_retain_sample_async(tenant_id, retain_sample_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item retain sample
        api_response = api_instance.patch_item_retain_sample_async(tenant_id, retain_sample_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of ItemRetainSamplesApi->patch_item_retain_sample_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRetainSamplesApi->patch_item_retain_sample_async: %s\n" % e)
```
