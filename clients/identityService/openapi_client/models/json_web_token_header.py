...
class JsonWebTokenHeader(BaseModel):
    """
    JsonWebTokenHeader
    """ # noqa: E501
    alg: Optional[StrictStr] = None
    jku: Optional[StrictStr] = None
    kid: Optional[StrictStr] = None
    typ: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alg", "jku", "kid", "typ"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if jku (nullable) is None
        # and model_fields_set contains the field
        if self.jku is None and "jku" in self.model_fields_set:
            _dict['jku'] = None
