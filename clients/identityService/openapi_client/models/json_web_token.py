...
class JsonWebToken(BaseModel):
    ...
    JsonWebToken
    """ # noqa: E501
    header: Optional[JsonWebTokenHeader] = None
    payload: Optional[JsonWebTokenPayload] = None
    ...
    __properties: ClassVar[List[str]] = ["header", "payload", "signature", "tokenType", "expiresIn", "accessToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "header": JsonWebTokenHeader.from_dict(obj["header"]) if obj.get("header") is not None else None,
            "payload": JsonWebTokenPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
