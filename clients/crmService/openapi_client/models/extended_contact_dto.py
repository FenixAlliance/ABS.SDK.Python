...
class ExtendedContactDto(BaseModel):
    """
    ExtendedContactDto
    """ # noqa: E501
    ...
    parent_contact: Optional[SimpleContactDto] = Field(default=None, alias="parentContact")
    primary_contact: Optional[SimpleContactDto] = Field(default=None, alias="primaryContact")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "qualifiedName", "tenantId", "type", "email", "phone", "publicName", "firstName", "lastName", "jobTitle", "coverUrl", "avatarUrl", "countryId", "timezoneId", "languageId", "socialProfileId", "webUrl", "gitHubUrl", "twitchUrl", "redditUrl", "tikTokUrl", "websiteUrl", "twitterUrl", "facebookUrl", "youTubeUrl", "linkedInUrl", "instagramUrl", "githubUsername", "duns", "taxId", "about", "street", "cartId", "cityId", "zipCode", "stateId", "walletId", "faxNumber", "postalCode", "currencyId", "streetLine1", "streetLine2", "territoryId", "mobilePhone", "enrollmentId", "annualRevenue", "relatedUserId", "businessPhone", "ownerContactId", "relatedTenantId", "activityFeedId", "parentContactId", "identityProvider", "partnerProfileId", "primaryContactId", "activeDirectoryId", "identityProviderAccessToken", "birthday", "cart", "wallet", "socialProfile", "parentContact", "primaryContact"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of parent_contact
        if self.parent_contact:
            _dict['parentContact'] = self.parent_contact.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parentContact": SimpleContactDto.from_dict(obj["parentContact"]) if obj.get("parentContact") is not None else None,
            "primaryContact": SimpleContactDto.from_dict(obj["primaryContact"]) if obj.get("primaryContact") is not None else None
        })
        return _obj
