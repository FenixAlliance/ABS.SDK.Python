...
class TestExtendedContactDtoListEnvelope(unittest.TestCase):
    """ExtendedContactDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedContactDtoListEnvelope:
        """Test ExtendedContactDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedContactDtoListEnvelope`
        """
        model = ExtendedContactDtoListEnvelope()
        if include_optional:
            return ExtendedContactDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.extended_contact_dto.ExtendedContactDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        qualified_name = '', 
                        tenant_id = '', 
    ...
    def testExtendedContactDtoListEnvelope(self):
        """Test ExtendedContactDtoListEnvelope"""
