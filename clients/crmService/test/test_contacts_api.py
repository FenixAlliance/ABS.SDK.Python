...
class TestContactsApi(unittest.TestCase):
    ...
    def test_preview_contact_email_template(self) -> None:
        """Test case for preview_contact_email_template

        Preview the rendered email for a contact.
        """
        pass

    def test_send_contact_email(self) -> None:
        """Test case for send_contact_email
