...
class TestExtendedContactDto(unittest.TestCase):
    """ExtendedContactDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedContactDto:
        """Test ExtendedContactDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedContactDto`
        """
        model = ExtendedContactDto()
        if include_optional:
            return ExtendedContactDto(
                id = '',
    ...
    def testExtendedContactDto(self):
        """Test ExtendedContactDto"""
