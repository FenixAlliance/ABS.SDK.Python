...
class DealUnitFlowDto(BaseModel):
    ...
    tenant_enrollment_id: Optional[StrictStr] = Field(default=None, alias="tenantEnrollmentId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "parentBusinessProcessId", "tenantId", "tenantEnrollmentId"]
