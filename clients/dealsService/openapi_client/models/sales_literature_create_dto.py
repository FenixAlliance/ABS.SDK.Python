...
class SalesLiteratureCreateDto(BaseModel):
    """
    SalesLiteratureCreateDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    title: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=100)]] = None
    content: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1000)]] = None
    ...
    enrolment_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, alias="enrolmentId")
    sales_literature_type_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, alias="salesLiteratureTypeId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "content", "description", "modifiedDate", "expirationDate", "tenantId", "enrolmentId", "salesLiteratureTypeId"]
