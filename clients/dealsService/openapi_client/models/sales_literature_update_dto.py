...
class SalesLiteratureUpdateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "content", "description", "modifiedDate", "expirationDate", "tenantId", "enrolmentId", "salesLiteratureTypeId"]
