...
class DealUnitFlowCreateDto(BaseModel):
    """
    ...
    tenant_enrolment_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, alias="tenantEnrolmentId")
