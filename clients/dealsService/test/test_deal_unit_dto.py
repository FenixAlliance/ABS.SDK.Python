...
class TestDealUnitDto(unittest.TestCase):
    """DealUnitDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitDto:
        """Test DealUnitDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitDto`
        """
        model = DealUnitDto()
        if include_optional:
            return DealUnitDto(
