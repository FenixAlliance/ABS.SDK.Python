...
class TestDealUnitLineUpdateDto(unittest.TestCase):
    """DealUnitLineUpdateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitLineUpdateDto:
        """Test DealUnitLineUpdateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitLineUpdateDto`
        """
        model = DealUnitLineUpdateDto()
        if include_optional:
            return DealUnitLineUpdateDto(
                closed = True,
                item_id = '',
                item_title = '',
    ...
    def testDealUnitLineUpdateDto(self):
        """Test DealUnitLineUpdateDto"""
