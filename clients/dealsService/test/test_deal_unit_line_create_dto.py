...
class TestDealUnitLineCreateDto(unittest.TestCase):
    """DealUnitLineCreateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitLineCreateDto:
        """Test DealUnitLineCreateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitLineCreateDto`
        """
        model = DealUnitLineCreateDto()
        if include_optional:
            return DealUnitLineCreateDto(
                closed = True,
                item_id = '',
                item_title = '',
    ...
    def testDealUnitLineCreateDto(self):
        """Test DealUnitLineCreateDto"""
