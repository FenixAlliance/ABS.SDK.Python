...
class TestDealUnitDtoEnvelope(unittest.TestCase):
    """DealUnitDtoEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitDtoEnvelope:
        """Test DealUnitDtoEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitDtoEnvelope`
        """
        model = DealUnitDtoEnvelope()
        if include_optional:
            return DealUnitDtoEnvelope(
                ...
                activity_id = '',
                result = openapi_client.models.deal_unit_dto.DealUnitDto(
                    id = '', 
                    timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed = True, 
                    type = '', 
    ...
    def testDealUnitDtoEnvelope(self):
        """Test DealUnitDtoEnvelope"""
