...
class TestDealUnitLineDto(unittest.TestCase):
    """DealUnitLineDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitLineDto:
        """Test DealUnitLineDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitLineDto`
        """
        model = DealUnitLineDto()
        if include_optional:
            return DealUnitLineDto(
                id = '',
