...
class TestDealUnitLineDtoListEnvelope(unittest.TestCase):
    """DealUnitLineDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DealUnitLineDtoListEnvelope:
        """Test DealUnitLineDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DealUnitLineDtoListEnvelope`
        """
        model = DealUnitLineDtoListEnvelope()
        if include_optional:
            return DealUnitLineDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.deal_unit_line_dto.DealUnitLineDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        closed = True, 
                        item_id = '', 
    ...
    def testDealUnitLineDtoListEnvelope(self):
        """Test DealUnitLineDtoListEnvelope"""
