...
class TestExtendedDealUnitDtoListEnvelope(unittest.TestCase):
    """ExtendedDealUnitDtoListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedDealUnitDtoListEnvelope:
        """Test ExtendedDealUnitDtoListEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedDealUnitDtoListEnvelope`
        """
        model = ExtendedDealUnitDtoListEnvelope()
        if include_optional:
            return ExtendedDealUnitDtoListEnvelope(
                ...
                activity_id = '',
                result = [
                    openapi_client.models.extended_deal_unit_dto.ExtendedDealUnitDto(
                        id = '', 
                        timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        closed = True, 
                        type = '', 
                        ...
                        receiver_tenant = openapi_client.models.tenant_dto.TenantDto(
                            ...
                            business_legal_name = '', 
                            twitter_username = '', ), 
                        enrollment = openapi_client.models.tenant_enrollment_dto.TenantEnrollmentDto(
                            id = '', 
                            timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            tenant_id = '', 
                            user_id = '', 
    ...
    def testExtendedDealUnitDtoListEnvelope(self):
        """Test ExtendedDealUnitDtoListEnvelope"""
