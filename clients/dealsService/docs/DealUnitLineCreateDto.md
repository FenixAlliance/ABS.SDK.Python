...
**custom_global_surcharges_amount_currency_id** | **str** |  | [optional] 
**custom_global_discounts_amount** | **float** |  | [optional] 
**custom_global_discounts_amount_currency_id** | **str** |  | [optional] 
...
json = "{}"
# create an instance of DealUnitLineCreateDto from a JSON string
deal_unit_line_create_dto_instance = DealUnitLineCreateDto.from_json(json)
# print the JSON string representation of the object
print(DealUnitLineCreateDto.to_json())

# convert the object into a dict
deal_unit_line_create_dto_dict = deal_unit_line_create_dto_instance.to_dict()
# create an instance of DealUnitLineCreateDto from a dict
deal_unit_line_create_dto_from_dict = DealUnitLineCreateDto.from_dict(deal_unit_line_create_dto_dict)
```
