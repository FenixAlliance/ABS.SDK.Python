...
deal_unit_line_update_dto_instance = DealUnitLineUpdateDto.from_json(json)
# print the JSON string representation of the object
print(DealUnitLineUpdateDto.to_json())

# convert the object into a dict
deal_unit_line_update_dto_dict = deal_unit_line_update_dto_instance.to_dict()
# create an instance of DealUnitLineUpdateDto from a dict
deal_unit_line_update_dto_from_dict = DealUnitLineUpdateDto.from_dict(deal_unit_line_update_dto_dict)
```
