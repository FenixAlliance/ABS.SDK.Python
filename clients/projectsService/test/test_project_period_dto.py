...
class TestProjectPeriodDto(unittest.TestCase):
    """ProjectPeriodDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPeriodDto:
        """Test ProjectPeriodDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPeriodDto`
        """
        model = ProjectPeriodDto()
        if include_optional:
