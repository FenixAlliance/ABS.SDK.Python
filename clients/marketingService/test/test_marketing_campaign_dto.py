...
class TestMarketingCampaignDto(unittest.TestCase):
    """MarketingCampaignDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketingCampaignDto:
        """Test MarketingCampaignDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketingCampaignDto`
        """
        model = MarketingCampaignDto()
        if include_optional:
    ...
    def testMarketingCampaignDto(self):
        """Test MarketingCampaignDto"""
