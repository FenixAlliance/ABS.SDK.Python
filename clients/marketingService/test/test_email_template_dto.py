...
class TestEmailTemplateDto(unittest.TestCase):
    """EmailTemplateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailTemplateDto:
        """Test EmailTemplateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailTemplateDto`
        """
