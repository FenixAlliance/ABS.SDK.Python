...
class MarketingLeadDto(BaseModel):
    """
    MarketingLeadDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "firstName", "lastName", "email", "phone", "company", "jobTitle", "source", "status", "notes", "score", "tenantId", "enrollmentId"]
