...
class MarketingListUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locked", "name", "purpose", "description", "source", "cost", "modifiedOn", "lastUsedOn", "currencyId", "marketingListType", "marketingListTarget"]
    ...
    def marketing_list_target_validate_enum(cls, value):
        ...
        if value not in set(['Individual', 'Organization', 'Lead']):
            raise ValueError("must be one of enum values ('Individual', 'Organization', 'Lead')")
        return value
