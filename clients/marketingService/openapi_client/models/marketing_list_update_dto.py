...
class MarketingListUpdateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locked", "name", "purpose", "description", "source", "cost", "modifiedOn", "lastUsedOn", "currencyId", "tenantId", "enrollmentId", "marketingListType", "marketingListTarget"]
