...
class SocialPostBucketCreateDto(BaseModel):
    """
    SocialPostBucketCreateDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=99)]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "tenantId", "enrolmentId"]
