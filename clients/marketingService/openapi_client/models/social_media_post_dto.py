...
class SocialMediaPostDto(BaseModel):
    """
    SocialMediaPostDto
    """ # noqa: E501
    ...
    social_post_bucket_id: Optional[StrictStr] = Field(default=None, alias="socialPostBucketId")
    enrollment_id: Optional[StrictStr] = Field(default=None, alias="enrollmentId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "content", "featuredImageUrl", "tenantId", "socialPostBucketId", "enrollmentId"]
