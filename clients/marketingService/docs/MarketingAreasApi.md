...
> EmptyEnvelope patch_marketing_area_async(tenant_id, marketing_area_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a marketing area
        api_response = api_instance.patch_marketing_area_async(tenant_id, marketing_area_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of MarketingAreasApi->patch_marketing_area_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketingAreasApi->patch_marketing_area_async: %s\n" % e)
```
