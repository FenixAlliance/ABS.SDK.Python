...
> EmptyEnvelope patch_email_template_async(tenant_id, email_template_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an email template
        api_response = api_instance.patch_email_template_async(tenant_id, email_template_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of EmailTemplatesApi->patch_email_template_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmailTemplatesApi->patch_email_template_async: %s\n" % e)
```
