...
> EmptyEnvelope patch_newsletter_async(tenant_id, newsletter_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a newsletter
        api_response = api_instance.patch_newsletter_async(tenant_id, newsletter_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of NewslettersApi->patch_newsletter_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NewslettersApi->patch_newsletter_async: %s\n" % e)
```
