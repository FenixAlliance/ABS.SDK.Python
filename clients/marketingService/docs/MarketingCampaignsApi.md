...
> EmptyEnvelope patch_marketing_campaign_async(tenant_id, marketingcampaign_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a marketing campaign
        api_response = api_instance.patch_marketing_campaign_async(tenant_id, marketingcampaign_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of MarketingCampaignsApi->patch_marketing_campaign_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketingCampaignsApi->patch_marketing_campaign_async: %s\n" % e)
```
