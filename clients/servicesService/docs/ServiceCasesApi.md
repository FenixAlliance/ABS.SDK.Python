...
> Envelope patch_service_case_async(tenant_id, service_case_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a service case
        api_response = api_instance.patch_service_case_async(tenant_id, service_case_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of ServiceCasesApi->patch_service_case_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceCasesApi->patch_service_case_async: %s\n" % e)
```
