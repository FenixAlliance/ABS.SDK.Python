...
json = "{}"
# create an instance of ServiceCaseCreateDto from a JSON string
service_case_create_dto_instance = ServiceCaseCreateDto.from_json(json)
# print the JSON string representation of the object
print(ServiceCaseCreateDto.to_json())

# convert the object into a dict
service_case_create_dto_dict = service_case_create_dto_instance.to_dict()
# create an instance of ServiceCaseCreateDto from a dict
service_case_create_dto_from_dict = ServiceCaseCreateDto.from_dict(service_case_create_dto_dict)
```
