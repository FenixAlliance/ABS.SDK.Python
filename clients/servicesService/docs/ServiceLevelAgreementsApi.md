...
> Envelope patch_service_level_agreement_async(tenant_id, service_level_agreement_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a service level agreement
        api_response = api_instance.patch_service_level_agreement_async(tenant_id, service_level_agreement_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of ServiceLevelAgreementsApi->patch_service_level_agreement_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceLevelAgreementsApi->patch_service_level_agreement_async: %s\n" % e)
```
