...
class ServiceLevelAgreementCreateDto(BaseModel):
    """
    ...
    service_level_id: Optional[StrictStr] = Field(default=None, alias="serviceLevelId")
    contact_id: Optional[StrictStr] = Field(default=None, alias="contactId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "serviceId", "serviceLevelId", "contactId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if service_level_id (nullable) is None
        # and model_fields_set contains the field
        if self.service_level_id is None and "service_level_id" in self.model_fields_set:
            _dict['serviceLevelId'] = None
