...
class ServiceCaseCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "instructions", "taxable", "workLocation", "serviceId", "serviceQueueId", "serviceCaseTypeId", "serviceLevelAgreementId", "individualId", "organizationId", "accountHolderId", "receiverBusinessId", "currencyId", "territoryId", "priceListId", "promisedStartDate", "promisedEndDate"]
