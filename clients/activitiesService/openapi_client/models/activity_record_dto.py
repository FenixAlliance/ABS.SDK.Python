...
class ActivityRecordDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "type", "title", "description", "completed", "dueDate", "activityFeedId", "activityTypeId", "tenantId", "enrollmentId", "socialProfileId", "parentActivityId", "inChargeEnrollmentId"]
