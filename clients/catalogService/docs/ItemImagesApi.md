...
> ItemImageDtoEnvelope get_item_image_by_id_async(item_image_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get item image by ID
        api_response = api_instance.get_item_image_by_id_async(item_image_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> ItemImageDtoListEnvelope get_item_images_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all item images
        api_response = api_instance.get_item_images_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> patch_item_image_async(tenant_id, item_image_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item image
        api_instance.patch_item_image_async(tenant_id, item_image_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
    except Exception as e:
        print("Exception when calling ItemImagesApi->patch_item_image_async: %s\n" % e)
```
