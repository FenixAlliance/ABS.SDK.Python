...
> Int32Envelope count_item_attributes_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Count item attributes
        api_response = api_instance.count_item_attributes_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> ItemAttributeDtoEnvelope get_item_attribute_by_id_async(item_attribute_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get item attribute by ID
        api_response = api_instance.get_item_attribute_by_id_async(item_attribute_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> ItemAttributeDtoListEnvelope get_item_attributes_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all item attributes
        api_response = api_instance.get_item_attributes_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> patch_item_attribute_async(tenant_id, item_attribute_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item attribute
        api_instance.patch_item_attribute_async(tenant_id, item_attribute_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
    except Exception as e:
        print("Exception when calling ItemAttributesApi->patch_item_attribute_async: %s\n" % e)
```
