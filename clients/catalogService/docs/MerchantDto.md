...
json = "{}"
# create an instance of MerchantDto from a JSON string
merchant_dto_instance = MerchantDto.from_json(json)
# print the JSON string representation of the object
print(MerchantDto.to_json())

# convert the object into a dict
merchant_dto_dict = merchant_dto_instance.to_dict()
# create an instance of MerchantDto from a dict
merchant_dto_from_dict = MerchantDto.from_dict(merchant_dto_dict)
```
