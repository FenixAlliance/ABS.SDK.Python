...
> ItemTagDtoEnvelope get_item_tag_by_id_async(item_tag_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get item tag by ID
        api_response = api_instance.get_item_tag_by_id_async(item_tag_id, tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
# **get_item_tags_async**
> ItemTagDtoListEnvelope get_item_tags_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all item tags
        api_response = api_instance.get_item_tags_async(tenant_id=tenant_id, api_version=api_version, x_api_version=x_api_version)
...
> patch_item_tag_async(tenant_id, item_tag_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item tag
        api_instance.patch_item_tag_async(tenant_id, item_tag_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
    except Exception as e:
        print("Exception when calling ItemTagsApi->patch_item_tag_async: %s\n" % e)
```
