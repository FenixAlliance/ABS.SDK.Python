...
> EmptyEnvelope patch_item_attribute_option_async(tenant_id, item_attribute_option_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an item attribute option
        api_response = api_instance.patch_item_attribute_option_async(tenant_id, item_attribute_option_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of ItemAttributeOptionsApi->patch_item_attribute_option_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemAttributeOptionsApi->patch_item_attribute_option_async: %s\n" % e)
```
