...
class ItemReturnPolicyDto(BaseModel):
    """
    ItemReturnPolicyDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "shippingCourierID", "type", "code", "title", "description", "isFree", "reduce", "isEnabled", "isDefault", "allowInternational", "hours", "days", "weeks", "months", "years", "value", "percentage", "currencyID", "countryID", "countryStateID", "customState", "customCity", "cityID", "businessID", "businessProfileRecordID"]
