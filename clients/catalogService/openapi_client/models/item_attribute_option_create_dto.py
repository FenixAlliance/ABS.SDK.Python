...
class ItemAttributeOptionCreateDto(BaseModel):
    """
    ...
    item_attribute_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="itemAttributeId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "name", "description", "itemAttributeId"]
