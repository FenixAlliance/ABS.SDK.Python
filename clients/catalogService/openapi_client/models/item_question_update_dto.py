...
class ItemQuestionUpdateDto(BaseModel):
    """
    ...
    question: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1000)]] = None
    __properties: ClassVar[List[str]] = ["title", "needsRevision", "question"]
