...
class MerchantDto(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if merchant_rating (nullable) is None
        # and model_fields_set contains the field
        if self.merchant_rating is None and "merchant_rating" in self.model_fields_set:
            _dict['merchantRating'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "merchantRating": obj.get("merchantRating")
        })
        return _obj
