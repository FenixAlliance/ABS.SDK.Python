...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.GigsApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GigsApi->get_gig_by_id_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GigsApi->get_gigs_async: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GigsApi->get_gigs_count_async: %s\n" % e)
```
...
# **patch_gig_async**
> EmptyEnvelope patch_gig_async(tenant_id, gig_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a gig
        api_response = api_instance.patch_gig_async(tenant_id, gig_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of GigsApi->patch_gig_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GigsApi->patch_gig_async: %s\n" % e)
```
