...
time_interval_create_dto_instance = TimeIntervalCreateDto.from_json(json)
# print the JSON string representation of the object
print(TimeIntervalCreateDto.to_json())

# convert the object into a dict
time_interval_create_dto_dict = time_interval_create_dto_instance.to_dict()
# create an instance of TimeIntervalCreateDto from a dict
time_interval_create_dto_from_dict = TimeIntervalCreateDto.from_dict(time_interval_create_dto_dict)
```
