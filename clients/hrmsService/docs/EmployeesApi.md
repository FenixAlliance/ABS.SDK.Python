...
> EmptyEnvelope patch_employee_async(tenant_id, employee_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch an employee
        api_response = api_instance.patch_employee_async(tenant_id, employee_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of EmployeesApi->patch_employee_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmployeesApi->patch_employee_async: %s\n" % e)
```
...
> EmptyEnvelope update_employee_async(tenant_id, employee_id, api_version=api_version, x_api_version=x_api_version, employee_profile_update_dto=employee_profile_update_dto)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_version = 'api_version_example' # str |  (optional)
    x_api_version = 'x_api_version_example' # str |  (optional)
    employee_profile_update_dto = openapi_client.EmployeeProfileUpdateDto() # EmployeeProfileUpdateDto |  (optional)

    try:
        # Update an employee
        api_response = api_instance.update_employee_async(tenant_id, employee_id, api_version=api_version, x_api_version=x_api_version, employee_profile_update_dto=employee_profile_update_dto)
