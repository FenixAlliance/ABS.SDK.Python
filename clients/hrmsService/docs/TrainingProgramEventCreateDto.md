...
training_program_event_create_dto_instance = TrainingProgramEventCreateDto.from_json(json)
# print the JSON string representation of the object
print(TrainingProgramEventCreateDto.to_json())

# convert the object into a dict
training_program_event_create_dto_dict = training_program_event_create_dto_instance.to_dict()
# create an instance of TrainingProgramEventCreateDto from a dict
training_program_event_create_dto_from_dict = TrainingProgramEventCreateDto.from_dict(training_program_event_create_dto_dict)
```
