...
> EmptyEnvelope patch_training_program_event_async(tenant_id, event_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a training program event
        api_response = api_instance.patch_training_program_event_async(tenant_id, event_id, api_version=api_version, x_api_version=x_api_version, operation=operation)
        print("The response of TrainingProgramEventsApi->patch_training_program_event_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TrainingProgramEventsApi->patch_training_program_event_async: %s\n" % e)
```
