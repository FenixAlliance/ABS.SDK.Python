...
class JobOfferDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "remote", "expectedHireDate", "title", "description", "technicalSkills", "nonTechnicalSkills", "certifications", "projectExperience", "technologies", "benefits", "isOfficialJobOffer", "isRemoteJobOffer", "isMidTimeJobOffer", "isUndergraduateOption", "minOverallExperienceYears", "availiablePositionsCount", "viewsCount", "minSalaryAmount", "maxSalaryAmount", "imageUrl", "location", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "externalUrl", "tenantId", "enrollmentId", "currencyId", "jobFieldId", "employerProfileId", "countryId", "countryStateId", "cityId"]
