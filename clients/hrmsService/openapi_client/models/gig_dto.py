...
class GigDto(BaseModel):
    ...
    min_budget: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minBudget")
    max_budget: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxBudget")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "remote", "type", "title", "description", "expectedDeliveryDate", "minBudget", "maxBudget", "location", "viewsCount", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "externalUrl", "tenantId", "enrollmentId", "employerProfileId", "currencyId", "countryId", "countryStateId", "cityId"]
