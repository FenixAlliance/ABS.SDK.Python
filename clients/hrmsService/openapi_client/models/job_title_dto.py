...
class JobTitleDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "title", "description", "grossPay", "netSalary", "currencyId", "countryId", "countryStateId", "cityId", "tenantId", "enrollmentId"]
