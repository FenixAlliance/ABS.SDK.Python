...
class EmployeeProfileDto(BaseModel):
    ...
    payroll_currency: Optional[StrictStr] = Field(default=None, alias="payrollCurrency")
    max_work_hours_per_day: Optional[StrictInt] = Field(default=None, alias="maxWorkHoursPerDay")
    job_title_id: Optional[StrictStr] = Field(default=None, alias="jobTitleId")
    employee_type_id: Optional[StrictStr] = Field(default=None, alias="employeeTypeId")
    __properties: ClassVar[List[str]] = ["id", "timestamp", "contactId", "tenantId", "type", "enrollmentId", "about", "verified", "submitted", "avatarUrl", "contact", "qualifiedName", "verificationTimestamp", "data", "dataLabel", "data1", "data1Label", "data2", "data2Label", "data3", "data3Label", "data4", "data4Label", "data5", "data5Label", "data6", "data6Label", "data7", "data7Label", "data8", "data8Label", "data9", "data9Label", "grossPay", "netSalary", "payrollCurrency", "maxWorkHoursPerDay", "jobTitleId", "employeeTypeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if gross_pay (nullable) is None
        # and model_fields_set contains the field
        if self.gross_pay is None and "gross_pay" in self.model_fields_set:
            _dict['grossPay'] = None

        # set to None if net_salary (nullable) is None
        # and model_fields_set contains the field
        if self.net_salary is None and "net_salary" in self.model_fields_set:
            _dict['netSalary'] = None

        # set to None if payroll_currency (nullable) is None
        # and model_fields_set contains the field
        if self.payroll_currency is None and "payroll_currency" in self.model_fields_set:
            _dict['payrollCurrency'] = None

        # set to None if max_work_hours_per_day (nullable) is None
        # and model_fields_set contains the field
        if self.max_work_hours_per_day is None and "max_work_hours_per_day" in self.model_fields_set:
            _dict['maxWorkHoursPerDay'] = None
        ...
        # set to None if employee_type_id (nullable) is None
        # and model_fields_set contains the field
        if self.employee_type_id is None and "employee_type_id" in self.model_fields_set:
            _dict['employeeTypeId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ContactDto.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            ...
            "payrollCurrency": obj.get("payrollCurrency"),
            "maxWorkHoursPerDay": obj.get("maxWorkHoursPerDay"),
            "jobTitleId": obj.get("jobTitleId"),
            "employeeTypeId": obj.get("employeeTypeId")
        })
        return _obj
