...
class GigDtoListEnvelope(BaseModel):
    """
    GigDtoListEnvelope
    """ # noqa: E501
    ...
    result: Optional[List[GigDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [GigDto.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
